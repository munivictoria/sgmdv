...
public class BusinessCatalogosBean implements BusinessCatalogos {
	...
	public static final String NAME = "EXP|Adm. Cat\341logos";
	...
	static {
		...
		documentoCatalogo.setAtributosConsultables("Nombre", "nombre");
	...
	@Override
	public void deleteTramiteCatalogo(TramiteCatalogo pTramiteCatalogo) throws Exception, RemoteException {
		Criterio locCriterio1 = Criterio.getInstance(this.entity, FaseCatalogo.class).crearAlias("listaTramitesCatalogos", "tramite")
				.add(Restriccion.IGUAL("tramite.idTramiteCatalogo", pTramiteCatalogo.getIdTramiteCatalogo())).setProyeccion(Proyeccion.COUNT());
		Criterio locCriterio2 = Criterio.getInstance(this.entity, TramiteProcedimiento.class).add(Restriccion.IGUAL("tramiteCatalogo", pTramiteCatalogo))
	...
	public TramiteCatalogo getTramiteCatalogoPorId(long pId) throws Exception, RemoteException {
		TramiteCatalogo locTramiteCatalogo = (TramiteCatalogo) Criterio.getInstance(this.entity, TramiteCatalogo.class).add(Restriccion.IGUAL("idTramiteCatalogo", pId)).uniqueResult();
	...
	private void validarTramiteCatalogo(TramiteCatalogo pTramiteCatalogo) throws Exception {
		...
		locCriterio.add(Restriccion.LIKE("nombre", pTramiteCatalogo.getNombre(), false)).add(Restriccion.DISTINTO("idTramiteCatalogo", pTramiteCatalogo.getIdTramiteCatalogo()))
				.setProyeccion(Proyeccion.COUNT());
	...
	public void deleteFaseCatalogo(FaseCatalogo pFaseCatalogo) throws Exception, RemoteException {
		Criterio locCriterio = Criterio.getInstance(this.entity, FaseCatalogo.class).crearAlias("listaFasesEspeciales", "fasesEspeciales")
				.add(Restriccion.IGUAL("fasesEspeciales.idFaseCatalogo", pFaseCatalogo.getIdFaseCatalogo())).setProyeccion(Proyeccion.COUNT());
	...
	public FaseCatalogo getFaseCatalogoPorId(long pId) throws Exception, RemoteException {
		FaseCatalogo locFaseCatalogo = (FaseCatalogo) Criterio.getInstance(this.entity, FaseCatalogo.class).add(Restriccion.IGUAL("idFaseCatalogo", pId)).uniqueResult();
	...
	@Override
	public void deleteDocumentoCatalogo(DocumentoCatalogo pDocumentoCatalogo) throws Exception, RemoteException {
		Criterio locCriterio = Criterio.getInstance(this.entity, TramiteCatalogo.class).crearAlias("listaDocumentosCatalogos", "documentos")
				.add(Restriccion.IGUAL("documentos.idDocumentoCatalogo", pDocumentoCatalogo.getIdDocumentoCatalogo())).setProyeccion(Proyeccion.COUNT());
	...
	public DocumentoCatalogo getDocumentoCatalogoPorId(long pId) throws Exception, RemoteException {
		DocumentoCatalogo locDocumentoCatalogo = (DocumentoCatalogo) Criterio.getInstance(this.entity, DocumentoCatalogo.class).add(Restriccion.IGUAL("idDocumentoCatalogo", pId))
				.uniqueResult();
	...
	private void validacionFaseNombreRepetido(FaseCatalogo pFaseCatalogo) throws RemoteException, Exception, CatalogosException {
		// FiltroFaseCatalogo ffc = new FiltroFaseCatalogo();
		// ffc.setNombre(pFaseCatalogo.getNombre());
		// ffc = findListaFaseCatalogo(ffc);

		Criterio locCriterio = Criterio.getInstance(this.entity, FaseCatalogo.class).add(Restriccion.LIKE("nombre", pFaseCatalogo.getNombre(), false))
				.add(Restriccion.DISTINTO("id", pFaseCatalogo.getIdFaseCatalogo())).setProyeccion(Proyeccion.COUNT());
		...
		// if(pFaseCatalogo.getIdFaseCatalogo() > 0 && ffc.getListaResultados().size() > 1)
		// throw new CatalogosException(FASE_NOMBRE_REPETIDO);
		// else if(pFaseCatalogo.getIdFaseCatalogo() <= 0 && !ffc.getListaResultados().isEmpty())
		// throw new CatalogosException(FASE_NOMBRE_REPETIDO);
	}
	...
	private void validacionDocumentoNombreRepetido(DocumentoCatalogo pDocumentoCatalogo) throws RemoteException, Exception, CatalogosException {
		...
		fdc = findListaDocumentoCatalogo(fdc);
	...
	public EstadoTramite getEstadosTramitePorId(long pId) throws Exception, RemoteException {
		EstadoTramite locEstadosTramite = (EstadoTramite) Criterio.getInstance(this.entity, EstadoTramite.class).add(Restriccion.IGUAL("idEstadoTramite", pId)).uniqueResult();
	...
	@Override
	public void deleteEstadosTramite(EstadoTramite pEstadosTramite) throws Exception, RemoteException {
		Criterio locCriterio = Criterio.getInstance(this.entity, TramiteCatalogo.class)
	...
	public void validarEstadosTramite(EstadoTramite pEstadosTramite) throws CatalogosException {
		if(pEstadosTramite != null) {
			if(pEstadosTramite.getNombre() != null) {
				Criterio locCriterio = Criterio.getInstance(entity, EstadoTramite.class).add(Restriccion.IGUAL("nombre", pEstadosTramite.getNombre()))
