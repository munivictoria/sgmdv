...
public class ImportarPlanDeCuentaView extends ABMImportarPlanDeCuentaView {

	
	private static final long serialVersionUID = -5670629887960277833L;
	
	public ImportarPlanDeCuentaView(JDialog owner) {
		super(owner);
		this.init();
	}
	
	public ImportarPlanDeCuentaView(JFrame owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ImportarPlanDeCuenta.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ImportarPlanDeCuenta.titulo");
