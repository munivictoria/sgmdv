...
public class EliminarAsociacionCuentaInteresRecargoView extends ABMAsociacionCuentaInteresRecargoView {
	
	private static final long serialVersionUID = -4226589318222919457L;

	public EliminarAsociacionCuentaInteresRecargoView(JFrame owner) {
		super(owner);
		this.init();
	}
	
	public EliminarAsociacionCuentaInteresRecargoView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("EliminarAsociacionCuentaInteresRecargo.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("EliminarAsociacionCuentaInteresRecargo.titulo");
