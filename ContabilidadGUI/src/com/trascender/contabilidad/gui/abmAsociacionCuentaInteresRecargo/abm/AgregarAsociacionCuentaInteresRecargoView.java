...
public class AgregarAsociacionCuentaInteresRecargoView extends ABMAsociacionCuentaInteresRecargoView {

	private static final long serialVersionUID = 1003364278315806938L;
	
	public AgregarAsociacionCuentaInteresRecargoView(JFrame owner) {
		super(owner);
		this.init();
	}
	
	public AgregarAsociacionCuentaInteresRecargoView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("AgregarAsociacionCuentaInteresRecargo.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("AgregarAsociacionCuentaInteresRecargo.titulo");
