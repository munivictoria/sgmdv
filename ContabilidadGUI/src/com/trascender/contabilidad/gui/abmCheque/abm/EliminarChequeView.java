...
public class EliminarChequeView extends ABMChequeView {

	private static final long serialVersionUID = 5513255615940373091L;

	public EliminarChequeView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("EliminarCheque.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("EliminarCheque.titulo");
