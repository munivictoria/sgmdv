...
public class ModificarChequeView extends ABMChequeView {

	private static final long serialVersionUID = 5513255615940373091L;

	public ModificarChequeView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarCheque.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ModificarCheque.titulo");
