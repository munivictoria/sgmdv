...
public class AcercaDeView extends ABMView {
	...
	private void init() {
		...
		Icon i = AppManager.getInstance().getAdminRecursos().getIcon(RecursosContabilidad.IMG_ACERCADE_VIPIANS);
	...
	public void setImagenCabecera() {
		Icon i = AppManager.getInstance().getAdminRecursos().getIcon(RecursosContabilidad.IMG_ACERCADE);
