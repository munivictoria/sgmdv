...
public class EliminarParametroRetencionView extends ABMParametroRetencionView {

	private static final long serialVersionUID = -2547019724411697744L;
	
	public EliminarParametroRetencionView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("EliminarParametroRetencion.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("EliminarParametroRetencion.titulo");
