...
public class AgregarParametroAsociacionView extends ABMParametroAsociacionView {

	private static final long serialVersionUID = -8542906580700826672L;

	public AgregarParametroAsociacionView(JDialog owner) {
		super(owner);
		this.init();
	}
	
	public AgregarParametroAsociacionView(JFrame owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("AgregarParametroAsociacion.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("AgregarParametroAsociacion.titulo");
