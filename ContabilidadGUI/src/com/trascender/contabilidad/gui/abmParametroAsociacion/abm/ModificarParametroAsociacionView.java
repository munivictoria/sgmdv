...
public class ModificarParametroAsociacionView extends ABMParametroAsociacionView {

	private static final long serialVersionUID = -4415007906372557295L;
	
	public ModificarParametroAsociacionView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarParametroAsociacion.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ModificarParametroAsociacion.titulo");
