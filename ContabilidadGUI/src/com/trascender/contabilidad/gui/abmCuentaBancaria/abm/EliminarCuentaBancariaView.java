...
public class EliminarCuentaBancariaView extends ABMCuentaBancariaView {

	private static final long serialVersionUID = 5513255615940373091L;

	public EliminarCuentaBancariaView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("EliminarCuentaBancaria.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("EliminarCuentaBancaria.titulo");
