...
public class AgregarCuentaBancariaView extends ABMCuentaBancariaView {

	private static final long serialVersionUID = 5513255615940373091L;

	public AgregarCuentaBancariaView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("AgregarCuentaBancaria.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("AgregarCuentaBancaria.titulo");
