...
public class ModificarMayorView extends ABMMayorView {
	
	private static final long serialVersionUID = 3096193988715320367L;

	public ModificarMayorView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarMayor.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ModificarMayor.titulo");
