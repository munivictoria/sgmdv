...
public class AgregarBalanceView extends ABMBalanceView {
	
	private static final long serialVersionUID = 3929169253162676995L;
	
	public AgregarBalanceView(JFrame owner) {
		super(owner);
		this.init();
	}

	public AgregarBalanceView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("AgregarBalance.titulo");
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("AgregarBalance.descripcion"));
	}
