...
public class AgregarAsientoContableView extends ABMAsientoContableView {
	
	private static final long serialVersionUID = -6395270424334074553L;
	
	
	public AgregarAsientoContableView(JFrame owner) {
		super(owner);
		this.init();
	}
	
	public AgregarAsientoContableView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	private void init(){
		...
		this.getCbTipoSubdiarioCaja().setEnabled(true);
		this.getCbTipoSubdiarioCaja().setEditable(false);
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("AgregarAsientoContable.titulo");
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("AgregarAsientoContable.descripcion"));
	}
