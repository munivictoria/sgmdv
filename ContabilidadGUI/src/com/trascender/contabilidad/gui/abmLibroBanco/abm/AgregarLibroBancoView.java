...
public class AgregarLibroBancoView extends ABMLibroBancoView {

	private static final long serialVersionUID = 5513255615940373091L;

	public AgregarLibroBancoView(JDialog owner) {
		super(owner);
		this.init();
	}
	
	public AgregarLibroBancoView(JFrame owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("AgregarLibroBanco.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("AgregarLibroBanco.titulo");
