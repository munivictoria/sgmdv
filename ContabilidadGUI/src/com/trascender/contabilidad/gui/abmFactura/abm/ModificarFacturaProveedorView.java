...
public class ModificarFacturaProveedorView extends ABMView {

	private static final long serialVersionUID = 6712602044526280218L;

	private FacturaProveedorABMModel abmModel;
	...
	private final String NOMBRE_RECURSO ="ModificarFacturaProveedor";
	private MaskFormatter formatter;
	
	public ModificarFacturaProveedorView(JDialog owner) throws Exception {
	...
	public ModificarFacturaProveedorView(JFrame owner) throws Exception {
		this.setImagenCabecera();
		this.setColorFondo();
		this.setDescripcionVentana();
		this.setTextoBtnAceptar();
...
//			this.PnlContenedorTablas.add(this.pnlTablaRemito);
	...
	public void setAbmModel(FacturaProveedorABMModel abmModel) {
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarFacturaProveedor.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ModificarFacturaProveedor.titulo");
