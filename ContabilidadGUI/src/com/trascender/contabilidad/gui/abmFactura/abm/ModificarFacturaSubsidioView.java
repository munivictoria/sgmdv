...
public class ModificarFacturaSubsidioView extends ABMView {

	private static final long serialVersionUID = 8875931353041903780L;

	private FacturaSubsidioABMModel abmModel;
	private LineaFacturaTableModel tableModel;

	private JPanel pnlContenedor;
		private JPanel pnlAtributos;
			private JLabel lblDigestoMunicipal;
			private JTextField tfDigestoMunicipal;
	...
	private final String NOMBRE_RECURSO ="ModificarFacturaSubsidio";
	private MaskFormatter formatter;
	
	public ModificarFacturaSubsidioView(JDialog owner) throws Exception {
	...
	public ModificarFacturaSubsidioView(JFrame owner) throws Exception {
		this.setImagenCabecera();
		this.setColorFondo();
		this.setDescripcionVentana();
		this.setTextoBtnAceptar();
	...
	private void init() {
		...
		this.pnlContenedor.setPreferredSize(new Dimension(200,300));
			...
			this.pnlAtributos.setLayout(null);
				...
				numFila++;
				this.lblDigestoMunicipal = new TLabel();
				this.lblDigestoMunicipal.setText(MessagesContabilidad.getString(NOMBRE_RECURSO + ".lblDigestoMunicipal"));
				this.lblDigestoMunicipal.setBounds(Util.getBoundsColumnaLabel(numFila));
				this.pnlAtributos.add(this.lblDigestoMunicipal);
				
				this.tfDigestoMunicipal = new JTextField();
				this.tfDigestoMunicipal.setEditable(false);
				this.tfDigestoMunicipal.setBounds(Util.getBoundsColumnaInputTextField(numFila));
				this.pnlAtributos.add(this.tfDigestoMunicipal);
...
//			this.PnlContenedorTablas.add(this.pnlTablaRemito);
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarFacturaSubsidio.descripcion"));
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ModificarFacturaSubsidio.titulo");
	...
	public JLabel getLblDigestoMunicipal() {
	...
	public JTextField getTfDigestoMunicipal() {
