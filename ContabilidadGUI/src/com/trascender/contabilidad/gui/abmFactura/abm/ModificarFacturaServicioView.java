...
public class ModificarFacturaServicioView extends ABMView {

	private static final long serialVersionUID = 2405806175668720929L;

	private FacturaServicioABMModel abmModel;
	...
	private final String NOMBRE_RECURSO ="ModificarFacturaServicio";
	private MaskFormatter formatter;

	public ModificarFacturaServicioView(JDialog owner) throws Exception  {
	...
	public ModificarFacturaServicioView(JFrame owner) throws Exception  {
		this.setImagenCabecera();
		this.setColorFondo();
		this.setDescripcionVentana();
		this.setTextoBtnAceptar();
	...
	private void init() {
		...
		this.pnlContenedor.setPreferredSize(new Dimension(200,300));
			...
			this.pnlAtributos.setLayout(null);
				...
				numFila++;
				this.lblBien = new TLabel();
				this.lblBien.setText(MessagesContabilidad.getString(NOMBRE_RECURSO + ".lblBien"));
				this.lblBien.setBounds(Util.getBoundsColumnaLabel(numFila));
				this.pnlAtributos.add(this.lblBien);
				
				this.tfBien = new JTextField();
				this.tfBien.setEditable(false);
				this.tfBien.setBounds(Util.getBoundsColumnaInputTextField(numFila));
				this.pnlAtributos.add(this.tfBien);
...
//			this.PnlContenedorTablas.add(this.pnlTablaRemito);
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarFacturaServicio.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ModificarFacturaServicio.titulo");
	...
	public void setAbmModel(FacturaServicioABMModel abmModel) {
