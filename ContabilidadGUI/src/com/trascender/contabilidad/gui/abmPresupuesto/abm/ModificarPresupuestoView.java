...
public class ModificarPresupuestoView extends ABMPresupuestoView {

	private static final long serialVersionUID = 5513255615940373091L;

	public ModificarPresupuestoView(JDialog owner) {
		super(owner);
		this.init();
	}
	
	public ModificarPresupuestoView(JFrame owner) {
		super(owner);
		this.init();
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ModificarPresupuesto.titulo");
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarPresupuesto.descripcion"));
	}
