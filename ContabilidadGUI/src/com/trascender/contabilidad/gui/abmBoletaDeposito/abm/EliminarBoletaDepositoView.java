...
public class EliminarBoletaDepositoView extends ABMBoletaDepositoView {

	private static final long serialVersionUID = 5513255615940373091L;

	public EliminarBoletaDepositoView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("EliminarBoletaDeposito.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("EliminarBoletaDeposito.titulo");
