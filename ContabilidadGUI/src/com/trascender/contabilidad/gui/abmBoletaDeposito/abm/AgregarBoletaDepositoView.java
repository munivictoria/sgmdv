...
public class AgregarBoletaDepositoView extends ABMBoletaDepositoView {

	private static final long serialVersionUID = 5513255615940373091L;

	public AgregarBoletaDepositoView(JDialog owner) {
		super(owner);
		this.init();
	}
	
	public AgregarBoletaDepositoView(JFrame owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("AgregarBoletaDeposito.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("AgregarBoletaDeposito.titulo");
