...
public class ModificarBoletaDepositoView extends ABMBoletaDepositoView {

	private static final long serialVersionUID = 5513255615940373091L;

	public ModificarBoletaDepositoView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarBoletaDeposito.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ModificarBoletaDeposito.titulo");
