...
public class EliminarDebitoBancarioView extends ABMDebitoBancarioView {

	private static final long serialVersionUID = 7679837515044369741L;

	public EliminarDebitoBancarioView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("EliminarDebitoBancario.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("EliminarDebitoBancario.titulo");
