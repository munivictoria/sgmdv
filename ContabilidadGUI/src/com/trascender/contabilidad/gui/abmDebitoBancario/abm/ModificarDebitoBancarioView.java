...
public class ModificarDebitoBancarioView extends ABMDebitoBancarioView {

	private static final long serialVersionUID = 1603493667998296821L;

	public ModificarDebitoBancarioView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarDebitoBancario.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ModificarDebitoBancario.titulo");
