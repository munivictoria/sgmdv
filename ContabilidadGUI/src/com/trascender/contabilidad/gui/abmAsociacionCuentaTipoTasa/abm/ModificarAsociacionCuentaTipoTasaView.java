...
public class ModificarAsociacionCuentaTipoTasaView extends ABMAsociacionCuentaTipoTasaView {
	
	private static final long serialVersionUID = 5513255615940373091L;
	
	public ModificarAsociacionCuentaTipoTasaView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarAsociacionCuentaTipoTasa.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ModificarAsociacionCuentaTipoTasa.titulo");
