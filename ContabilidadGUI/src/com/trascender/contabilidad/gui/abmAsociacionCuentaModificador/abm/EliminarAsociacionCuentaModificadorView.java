...
public class EliminarAsociacionCuentaModificadorView extends ABMAsociacionCuentaModificadorView {
	
	private static final long serialVersionUID = -4226589318222919457L;

	public EliminarAsociacionCuentaModificadorView(JFrame owner) {
		super(owner);
		this.init();
	}
	
	public EliminarAsociacionCuentaModificadorView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("EliminarAsociacionCuentaModificador.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("EliminarAsociacionCuentaModificador.titulo");
