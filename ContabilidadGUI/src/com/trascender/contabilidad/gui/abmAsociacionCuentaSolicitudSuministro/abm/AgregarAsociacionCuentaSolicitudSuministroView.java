...
public class AgregarAsociacionCuentaSolicitudSuministroView extends ABMAsociacionCuentaSolicitudSuministroView {

	private static final long serialVersionUID = -881904828996918955L;
	
	private final String NOMBRE_RECURSO = "AgregarAsociacionCuentaSolicitudSuministro";

	public AgregarAsociacionCuentaSolicitudSuministroView(JDialog owner) {
		super(owner);
		this.init();
	}
	
	public AgregarAsociacionCuentaSolicitudSuministroView(JFrame owner) {
		super(owner);
		this.init();
	}
