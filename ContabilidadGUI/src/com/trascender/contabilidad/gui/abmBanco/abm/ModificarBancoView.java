...
public class ModificarBancoView extends ABMBancoView {

	private static final long serialVersionUID = 5513255615940373091L;
	
	public ModificarBancoView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarBanco.descripcion"));		
	}
	...
	public void setTituloVentana() {
		String titulo = MessagesContabilidad.getString("ModificarBanco.titulo");
