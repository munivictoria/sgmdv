...
public class AgregarBancoView extends ABMBancoView {

	private static final long serialVersionUID = 5513255615940373091L;
	
	public AgregarBancoView(JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("AgregarBanco.descripcion"));
	}	
	...
	public void setTituloVentana() {
		String titulo = MessagesContabilidad.getString("AgregarBanco.titulo");
