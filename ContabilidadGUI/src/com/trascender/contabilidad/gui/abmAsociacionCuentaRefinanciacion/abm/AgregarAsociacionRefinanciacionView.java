...
public class AgregarAsociacionRefinanciacionView extends ABMAsociacionRefinanciacionView {

	private static final long serialVersionUID = -3315125522127917556L;

	public AgregarAsociacionRefinanciacionView(JDialog owner) {
		super(owner);
		this.init();
	}
	
	public AgregarAsociacionRefinanciacionView(JFrame owner) {
		super(owner);
		this.init();
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("AgregarAsociacionRefinanciacion.titulo");
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("AgregarAsociacionRefinanciacion.descripcion"));
	}
