...
public class ModificarAsociacionCuentaConceptoSelladoAdministrativoView extends ABMAsociacionCuentaConceptoSelladoAdministrativoView {

	private static final long serialVersionUID = 1327378213178993318L;
	
	
	public ModificarAsociacionCuentaConceptoSelladoAdministrativoView(
			JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarAsociacionCuentaConceptoSelladoAdministrativo.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ModificarAsociacionCuentaConceptoSelladoAdministrativo.titulo");
