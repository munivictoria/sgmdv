...
public class EliminarReporteContableView extends ABMReporteContableView{

	private static final long serialVersionUID = -4533222089277004674L;

	public EliminarReporteContableView(JDialog owner) {
		super(owner);
		this.init();
	}
	
	public EliminarReporteContableView(JFrame owner) {
		super(owner);
		this.init();
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("EliminarReporteContable.titulo");
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("EliminarReporteContable.descripcion"));
	}
