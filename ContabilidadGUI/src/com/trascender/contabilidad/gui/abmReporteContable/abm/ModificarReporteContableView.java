...
public class ModificarReporteContableView extends ABMReporteContableView{

	private static final long serialVersionUID = -8936240593626931109L;

	public ModificarReporteContableView(JDialog owner) {
		super(owner);
		this.init();
	}
	
	public ModificarReporteContableView(JFrame owner) {
		super(owner);
		this.init();
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesContabilidad.getString("ModificarReporteContable.titulo");
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesContabilidad.getString("ModificarReporteContable.descripcion"));
	}
