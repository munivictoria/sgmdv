...
public class UsuarioTableModel extends TAbstractTableModel<Usuario> {
	...
	private static final long serialVersionUID = -5449064028515362707L;
	...
	private List<TColumnField> inicializarColumnas() throws TrascenderException {
		...
		try {
			...
			locListaColumnas.add(new TColumnField("Persona", Usuario.class.getDeclaredField("personaFisicaRfr")));
