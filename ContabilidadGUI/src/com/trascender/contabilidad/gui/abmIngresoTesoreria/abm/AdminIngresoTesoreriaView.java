...
public class AdminIngresoTesoreriaView extends ABMView {
	...
	private final String NOMBRE_RECURSO = "IngresoTesoreria";

	public AdminIngresoTesoreriaView() {
		this.setColorFondo();
...
//		this.setImagenCabecera();
	...
	public void setTituloVentana() {
		this.getPnlCabecera().getLblTitulo().setText(MessagesContabilidad.getString("IngresoTesoreria.titulo"));
	}
