...
public class LiquidacionOspDS extends TrascenderDataSource{
	
	private int lineaActual = -1;
	private Map <String, Object>parametros;
	private List<Map<String, Object>> filas = new ArrayList<Map<String,Object>>();
	
	public LiquidacionOspDS (List<LiquidacionTasa> pListaLiquidacionTasa, String pTitulo, String pSubTitulo){
		...
		for (LiquidacionTasa cadaLiquidacionTasa : pListaLiquidacionTasa){
				...
				locMapa.put("F_DOCUMENTO_OSP", cadaLiquidacionTasa.getDocGeneradorDeuda().getObligacion().getDocumentoEspecializado());
				filas.add(locMapa);
		}
	}
	...
	public String getNombreReporte() {
		// TODO Auto-generated method stub
		return "Reporte_Liquidacion_OSP.jasper";
	}
