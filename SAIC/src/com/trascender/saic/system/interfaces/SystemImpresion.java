...
/**
 * Remote interface for SystemImpresion.
 ...
 */
@Remote
public interface SystemImpresion
{
	public static final String JNDI_NAME="ejb/SystemImpresion/remote";

	public void setLlave(long pLlave);

	public JasperPrint getReporteOSP( com.trascender.framework.recurso.persistent.Persona pPersona,com.trascender.catastro.recurso.persistent.Cuadra pCuadra,com.trascender.habilitaciones.recurso.persistent.osp.ServicioOSP pServicioOSP,java.lang.Boolean pServicioMedido,com.trascender.catastro.recurso.persistent.Calle pCalle,com.trascender.framework.recurso.transients.Periodo pPeriodo,EstadoRegistroDeuda pEstadoRegistroDeuda,String pCuentaSubcuenta )
			throws Exception;
	...
	public JasperPrint getReporteListadoCuotasRefinanciacion(DocumentoRefinanciacion pDocumentoRefinanciacion) 
			throws Exception;

	public JasperPrint getReporteReliquidacion(RegistroDeuda pRegistroDeuda,
			Usuario pUsuario,
			boolean pImprimirReporteSimple) throws Exception;
