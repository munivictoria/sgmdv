 ...
 * Page1.java
 *
 * Created on 22 de agosto de 2006, 09:24
 * Copyright Asus
 */
package muni;
...
public class Page1 extends AbstractPageBean {
    ...
    public void init() {
        ...
        // INICIALIZACION DE VARIABLES DE APLICACION
        this.getApplicationBean1().setCantidadFilasTablasAdmin( new Integer(15) );
        this.getApplicationBean1().setSuperUsuario("root");
