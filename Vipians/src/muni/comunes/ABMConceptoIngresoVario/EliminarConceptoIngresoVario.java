 ...
 */
public class EliminarConceptoIngresoVario extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Eliminar Concepto de Sellado";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EliminarConceptoSellado";
     ...
     */
    public EliminarConceptoIngresoVario() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("EliminarConceptoSellado Initialization Failure", e);
    ...
    public String btnEliminar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getCommunicationCajaBean().getRemoteSystemAdministracionIngresos().deleteConceptoIngresoVario(conceptoSellado);
                
                this.getRequestBean1().setRespuestaABM(conceptoSellado);
                
                info("El Concepto de Sellado se elimin\363 exitosamente.");
