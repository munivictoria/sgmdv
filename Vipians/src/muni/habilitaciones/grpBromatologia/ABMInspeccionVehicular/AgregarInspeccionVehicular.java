/*
 * AgregarInspeccionVehicular.java
 *
 * Created on 24 de octubre de 2006, 10:40
 * Copyright Trascender SRL
 */
package muni.habilitaciones.grpBromatologia.ABMInspeccionVehicular;
 ...
 */
public class AgregarInspeccionVehicular extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Agregar Inspecci\363n Transporte Vehicular";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AgregarInspeccionVehicular";
    ...
    private TextField tfTransporteVehicular = new TextField();
    
    public TextField getTfTransporteVehicular() {
        return tfTransporteVehicular;
    }
    
    public void setTfTransporteVehicular(TextField tf) {
        this.tfTransporteVehicular = tf;
    }
     ...
     */
    public AgregarInspeccionVehicular() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("AgregarInspeccionVehicular Initialization Failure", e);
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        ...
        ep.getObjetos().add(ind++, new InspeccionVehicular());
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        int ind = 0;
        InspeccionVehicular inspeccionVehicular = (InspeccionVehicular) this.obtenerObjetoDelElementoPila(ind++, InspeccionVehicular.class);
        ...
        if ((estado != null) && (estado.toString().length() > 0)) inspeccionVehicular.setEstado(InspeccionSHPS.Estado.valueOf(estado.toString())); else inspeccionVehicular.setEstado(null);
        
        if (fecha != null && fecha != "") inspeccionVehicular.setFecha(Conversor.getFechaCortaDeString(fecha.toString())); else inspeccionVehicular.setFecha(null);
        if (descripcion != null && descripcion != "") inspeccionVehicular.setDescripcion(descripcion.toString()); else inspeccionVehicular.setDescripcion(null);
        
        inspeccionVehicular.setInspector(inspector);
        inspeccionVehicular.setTransporteVehicular(transporteVehicular);
        
        ind = 0;
        this.getElementoPila().getObjetos().set(ind++, inspeccionVehicular);
    ...
    private void mostrarEstadoObjetosUsados() {
        // CAMBIAR: Revisar el metodo completo.
        InspeccionVehicular inspeccionVehicular = null;
        ...
        if (this.getRequestBean1().getObjetoSeleccion() != null) {
            ...
            if (seleccionado instanceof TransporteVehicular) {
                transporteVehicular = (TransporteVehicular) seleccionado;
                this.getElementoPila().getObjetos().set(1, transporteVehicular);
        ...
        if (this.getRequestBean1().getObjetoABM() != null) {
            inspeccionVehicular = (InspeccionVehicular) this.getRequestBean1().getObjetoABM();
            transporteVehicular = inspeccionVehicular.getTransporteVehicular();
            inspector = inspeccionVehicular.getInspector();
            this.getElementoPila().getObjetos().set(0, inspeccionVehicular);
            this.getElementoPila().getObjetos().set(1, transporteVehicular);
            this.getElementoPila().getObjetos().set(2, inspector);
        }
        
        int ind = 0;
        inspeccionVehicular = (InspeccionVehicular) this.obtenerObjetoDelElementoPila(ind++, InspeccionVehicular.class);
        ...
        this.getTfTransporteVehicular().setText(transporteVehicular.toString());
        this.getTfInspector().setText(inspector.toString());
        this.getTfFecha().setText(Conversor.getStringDeFechaCorta(inspeccionVehicular.getFecha()));
        this.getTaDescripcion().setText(inspeccionVehicular.getDescripcion());
        
        ddEstado.setSelected(Util.getEnumNameFromString(String.valueOf(inspeccionVehicular.getEstado())));
        ddEstadoDefaultOptions.setSelectedValue(Util.getEnumNameFromString(String.valueOf(inspeccionVehicular.getEstado())));
    }
    // </editor-fold>
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                // CAMBIAR:
                InspeccionVehicular inspeccionVehicular = (InspeccionVehicular) this.obtenerObjetoDelElementoPila(0, InspeccionVehicular.class);
                
                this.getRequestBean1().setRespuestaABM(inspeccionVehicular);
