/*
 * ConsultarInspeccionComercial.java
 *
 ...
 */
public class ConsultarInspeccionComercial extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Consultar Inspecci\363n Local Comercial";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ConsultarInspeccionComercial";
    ...
    private TextField tfLocalComercial = new TextField();
    
    public TextField getTfLocalComercial() {
        return tfLocalComercial;
    }
    
    public void setTfLocalComercial(TextField tf) {
        this.tfLocalComercial = tf;
    }
     ...
     */
    public ConsultarInspeccionComercial() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("ConsultarInspeccionComercial Initialization Failure", e);
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        inspeccionComercial.setLocalComercial(localComercial);
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        if (this.getRequestBean1().getObjetoSeleccion() != null) {
            ...
            if (seleccionado instanceof LocalComercial) {
                localComercial = (LocalComercial) seleccionado;
                
                LocalComercial nuevoLocalComercial = null;
                try { nuevoLocalComercial = localComercial.clone();} 
                catch (CloneNotSupportedException ex) {
                     error("CloneError: "+ex.getMessage());
                }
                this.getElementoPila().getObjetos().set(1, nuevoLocalComercial);
        ...
        if (this.getRequestBean1().getObjetoABM() != null) {
            ...
            localComercial = inspeccionComercial.getLocalComercial();
            inspector = inspeccionComercial.getInspector();
            this.getElementoPila().getObjetos().set(0, inspeccionComercial);
            this.getElementoPila().getObjetos().set(1, localComercial);
        ...
        this.getTfLocalComercial().setText(localComercial.toString());
