 ...
 */
public class ConsultarServicioOSP extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Consultar C\363digo de Servicio de OSP";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ConsultarServicioOSP";
    ...
    private void _init() throws Exception {
        ...
        opPeriodicidad = this.getApplicationBean1().getMgrDropDown().armarArrayOptions(Periodicidad.values(), "cap");
