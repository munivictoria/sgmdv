 ...
 */
public class EliminarConsumoBasico extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Eliminar Consumo B\341sico";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EliminarConsumoBasico";
    ...
    public void init() {
        ...
        try {
            ...
            log("EliminarConsumoBasico Initialization Failure", e);
    ...
    public String btnEliminar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getCommunicationHabilitacionesBean().getRemoteSystemDocumentoOSP().deleteConsumoBasico(consumoBasico);
                
                this.getRequestBean1().setRespuestaABM(consumoBasico);
                
                info("El Consumo B\341sico se elimin\363 exitosamente.");
