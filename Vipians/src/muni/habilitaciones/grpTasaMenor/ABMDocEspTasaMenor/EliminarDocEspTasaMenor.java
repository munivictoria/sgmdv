 ...
 */
public class EliminarDocEspTasaMenor extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Eliminar Obligaci\363n: Tasa Menor";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EliminarDocEspTasaMenor";
     ...
     */
    public EliminarDocEspTasaMenor() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("EliminarDocEspTasaMenor Initialization Failure", e);
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        if (this.getRequestBean1().getObjetoABM() != null) {
            ...
            try {
                ...
                documentoTasaMenor.setObligacion(obligacion);
            } catch (Exception ex) {
    ...
    public String btnEliminar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                System.out.println("+++++ Doc. Tasa Menor " + documentoTasaMenor);
                documentoTasaMenor.getObligacion().anular();
                ...
                System.out.println("+++++ Obligacion " + documentoTasaMenor.getObligacion());
                this.getCommunicationHabilitacionesBean().getRemoteSystemObligacion().updateObligacion(documentoTasaMenor.getObligacion());
                System.out.println("+++++ Hizo update");

                //                      Rutina de Modificacion 
                // CAMBIAR: Objeto a guardar
               /*
                 * DocumentoTGI documentoTGI = (DocumentoTGI)
                 * this.getElementoPila().getObjetos().get(1);
                 *
                 * this.getCommunicationHabilitacionesBean().getRemoteSystemDocumentoTGI().setLlave(this.getSessionBean1().getLlave());
                 * this.getCommunicationHabilitacionesBean().getRemoteSystemDocumentoTGI().updateDocumentoTGI(documentoTGI);
                 */
                info("La Obligaci\363n de Tasa Menor se elimin\363 exitosamente.");
