package muni.habilitaciones.grpTipoParametro.ABMTipoParametroVehiculo;
...
import muni.habilitaciones.grpTipoParametro.ABMTipoParametroVehiculo.AdminTipoParametroVehiculo;
...
public class AdminTipoParametroVehiculo extends AbstractPageBean{
    ...
    private final String NOMBRE_PAGINA = "Administraci\363n de Par\341metros de Vehículo";
    private final String CASO_NAVEGACION = "AdminTipoParametroVehiculo";
    private final String CASO_NAV_CADUCIDAD = "PaginaCaducidad";
    private final String CASO_NAV_POST_CADUCIDAD = "Main";
    private final boolean PUEDE_SER_PAGINA_INICIAL = true;
    private final String lnkAgregar = "AgregarTipoParametroVehiculo";
    private final String lnkModificar = "ModificarTipoParametroVehiculo";
    private final String lnkEliminar = "EliminarTipoParametroVehiculo";
    ...
    private ObjectListDataProvider ldpTipoParametroVehiculo = new ObjectListDataProvider();
    
    public ObjectListDataProvider getLdpTipoParametroVehiculo() {
		return ldpTipoParametroVehiculo;
	}

	public void setLdpTipoParametroVehiculo(ObjectListDataProvider ldpTipoParametroVehiculo) {
		this.ldpTipoParametroVehiculo = ldpTipoParametroVehiculo;
	}
...
protected HtmlAjaxCommandButton btnReiniciar = new HtmlAjaxCommandButton();
    ...
    private TableSelectPhaseListener getTableSelectPhaseListener() {
        return this.getCommunicationHabilitacionesBean().getTablePhaseListenerParametroVehiculo();
    }

    public AdminTipoParametroVehiculo() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("AdminTipoParametroVehiculo Initialization Failure", e);
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        int ind = 0;
        ep.getObjetos().add(ind++, new String()); // para saber si es TipoParametroVehiculo/

        return ep;
    }

    private void guardarEstadoObjetosUsados() {
    	String tipoParametroVehiculo = (String) this.obtenerObjetoDelElementoPila(0, String.class);

        this.getElementoPila().getObjetos().set(0, tipoParametroVehiculo);
    }
    ...
    private void mostrarEstadoObjetosUsados() {
    	...
    	if (this.getRequestBean1().getObjetoSeleccion() != null) {
    		tipoParametroVehiculo = (String) this.getRequestBean1().getObjetoSeleccion().toString();
            this.getElementoPila().getObjetos().set(0, tipoParametroVehiculo);
        }
    	
        if (this.getLdpTipoParametroVehiculo().getList() != null){
        ...
        try {
            ...
            Logger.getLogger(AdminTipoParametroVehiculo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void refrescarTabla() throws Exception {
    	...
    	if (tipoParametroVehiculo != null && tipoParametroVehiculo != "") {
    		
    		if(tipoParametroVehiculo.equals("AUTOMOTOR")){
    			this.setListaDelCommunication((ArrayList) this.getCommunicationHabilitacionesBean().getRemoteSystemTipoTasa().getListaTiposParametrosVehiculo());
    		}
    ...
    private ObjectListDataProvider getObjectListDataProvider() {
        ...
        return this.getLdpTipoParametroVehiculo();
    }

    private List getListaDelCommunication() {
        return this.getCommunicationHabilitacionesBean().getListaTiposParametroVehiculo();
    }

    private void setListaDelCommunication(List lista) {
        this.getCommunicationHabilitacionesBean().setListaTiposParametroVehiculo(lista);
    }
    ...
    public String btnSeleccionar_action() {
        ...
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
        if (ultimo) {
        	Object locTipoParametroVehiculo = null;
                ...
                for (int i = 0; i < selectedRowKeys.length; i++) {
                    ...
                    if (tipoSeleccionado != null && tipoSeleccionado != "") {
                        if (tipoSeleccionado.equals("AUTOMOTOR")) {
                        	locTipoParametroVehiculo = (TipoParametro) obj;
                        }
                        this.getRequestBean1().getObjetosSeleccionMultiple().add(locTipoParametroVehiculo);
                    }
                }
            } catch (Exception ex) {
    ...
    public String btnExportar_action() {
        ...
        if (ultimo) {
            try {
                JasperPrint jp = ImpresionReporteDinamico.imprimirLista(this.getListaDelCommunication(), this.getTableRowGroup1(), "Reporte Din\341mico de Par\341metros Vehículo");
                ...
                FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("reportName", "Reporte_ParametrosVehiculo");
