/*
 * AdminTipoParametroPersona.java
 *
 * Created on 18 de octubre de 2006, 8:55
 * Copyright Trascender SRL
 */
package muni.habilitaciones.grpTipoParametro.ABMTipoParametroPersona;
 ...
 */
public class AdminTipoParametroPersona extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Administraci\363n de Par\341metros de Personas";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AdminTipoParametroPersona";
    ...
    private final String lnkAgregar = "AgregarTipoParametroPersona";
    private final String lnkModificar = "ModificarTipoParametroPersona";
    private final String lnkEliminar = "EliminarTipoParametroPersona";
    // </editor-fold>
    ...
    private ObjectListDataProvider ldpTipoParametroPersona = new ObjectListDataProvider();

    public ObjectListDataProvider getLdpTipoParametroPersona() {
        return ldpTipoParametroPersona;
    }

    public void setLdpTipoParametroPersona(ObjectListDataProvider oldp) {
        this.ldpTipoParametroPersona = oldp;
    }
 ...
 protected HtmlAjaxCommandButton btnBuscar = new HtmlAjaxCommandButton();
  ...
  protected HtmlAjaxCommandButton btnReiniciar = new HtmlAjaxCommandButton();
    ...
    private TableSelectPhaseListener getTableSelectPhaseListener() {
        ...
        return this.getCommunicationHabilitacionesBean().getTablePhaseListenerParametroPersona();
    }
     ...
     */
    public AdminTipoParametroPersona() {
    }
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        ...
        ep.getObjetos().add(ind++, new TipoParametroPersona());
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        TipoParametroPersona tipoParametroPersona = (TipoParametroPersona) this.obtenerObjetoDelElementoPila(0, TipoParametroPersona.class);

        this.getElementoPila().getObjetos().set(0, tipoParametroPersona);
    }

    private void mostrarEstadoObjetosUsados() {
        // CAMBIAR: Revisar el metodo completo.
        TipoParametroPersona tipoParametroPersona = null;

        tipoParametroPersona = (TipoParametroPersona) this.obtenerObjetoDelElementoPila(0, TipoParametroPersona.class);
        
        if (this.getLdpTipoParametroPersona().getList() != null){
    ...
    private void refrescarTabla() throws Exception {
        ...
        this.setListaDelCommunication((ArrayList) this.getCommunicationHabilitacionesBean().getRemoteSystemTipoTasa().getListaTiposParametrosPersonas());
    ...
    private ObjectListDataProvider getObjectListDataProvider() {
        ...
        return this.getLdpTipoParametroPersona();
    }

    private ArrayList getListaDelCommunication() {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        return this.getCommunicationHabilitacionesBean().getListaTiposParametroPersona();
    }

    private void setListaDelCommunication(ArrayList lista) {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        this.getCommunicationHabilitacionesBean().setListaTiposParametroPersona(lista);
    }
    ...
    public String btnSeleccionar_action() {
        ...
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
        if (ultimo) {
            TipoParametro locTipoParametroPersona = null;
            try {
                ...
                for (int i = 0; i < selectedRowKeys.length; i++) {
                    ...
                    locTipoParametroPersona = (TipoParametro) obj;
                    this.getRequestBean1().getObjetosSeleccionMultiple().add(locTipoParametroPersona);
                }
            } catch (Exception ex) {
...
//        return retorno;
    ...
    public String btnExportar_action() {
        ...
        if (ultimo) {
            try {
                JasperPrint jp = ImpresionReporteDinamico.imprimirLista(this.getListaDelCommunication(), this.getTableRowGroup1(), "Reporte Din\341mico de Par\341metros de Personas");
                ...
                FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("reportName", "Reporte_ParametrosPersonas");
