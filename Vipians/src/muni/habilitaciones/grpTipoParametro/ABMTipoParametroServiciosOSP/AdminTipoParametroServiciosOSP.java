package muni.habilitaciones.grpTipoParametro.ABMTipoParametroServiciosOSP;
...
public class AdminTipoParametroServiciosOSP extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Administraci\363n de Par\341metros de Servicios OSP";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AdminTipoParametroServiciosOSP";
    ...
    private final String lnkAgregar = "AgregarTipoParametroServiciosOSP";
    private final String lnkModificar = "ModificarTipoParametroServiciosOSP";
    private final String lnkEliminar = "EliminarTipoParametroServiciosOSP";
    // </editor-fold>
    ...
    private ObjectListDataProvider ldpTipoParametroServiciosOSP = new ObjectListDataProvider();

    public ObjectListDataProvider getLdpTipoParametroServiciosOSP() {
        return ldpTipoParametroServiciosOSP;
    }

    public void setLdpTipoParametroServiciosOSP(ObjectListDataProvider oldp) {
        this.ldpTipoParametroServiciosOSP = oldp;
    }
 ...
 protected HtmlAjaxCommandButton btnReiniciar = new HtmlAjaxCommandButton();
    ...
    private TableSelectPhaseListener getTableSelectPhaseListener() {
        ...
        return this.getCommunicationHabilitacionesBean().getTablePhaseListenerParametroServiciosOSP();
    }
     ...
     */
    public AdminTipoParametroServiciosOSP() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("AdminTipoParametroServiciosOSP Initialization Failure", e);
...
//        ep.getObjetos().add(ind++, new TipoParametroOSP());
    ...
    private void mostrarEstadoObjetosUsados() {
        if (this.getLdpTipoParametroServiciosOSP().getList() != null){
    ...
    private void refrescarTabla() throws Exception {
        ...
        this.setListaDelCommunication((ArrayList) this.getCommunicationHabilitacionesBean().getRemoteSystemTipoTasa().getListaParametrosAlicuotaOSP());
    ...
    private ObjectListDataProvider getObjectListDataProvider() {
        ...
        return this.getLdpTipoParametroServiciosOSP();
    }

    private ArrayList getListaDelCommunication() {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        return this.getCommunicationHabilitacionesBean().getListaTiposParametroServiciosOSP();
    }

    private void setListaDelCommunication(ArrayList lista) {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        this.getCommunicationHabilitacionesBean().setListaTiposParametroServiciosOSP(lista);
    }
    ...
    public String btnSeleccionar_action() {
        ...
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
        if (ultimo) {
            TipoParametroAlicuota locTipoParametroOSP = null;
            try {
                ...
                for (int i = 0; i < selectedRowKeys.length; i++) {
                    ...
                    locTipoParametroOSP = (TipoParametroAlicuota) obj;
...
//        return retorno;
    ...
    public String btnExportar_action() {
        ...
        if (ultimo) {
            try {
                JasperPrint jp = ImpresionReporteDinamico.imprimirLista(this.getListaDelCommunication(), this.getTableRowGroup1(), "Reporte Din\341mico de Par\341metros de Servicios OSP");
                ...
                FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("reportName", "Reporte_ParametrosServiciosOSP");
