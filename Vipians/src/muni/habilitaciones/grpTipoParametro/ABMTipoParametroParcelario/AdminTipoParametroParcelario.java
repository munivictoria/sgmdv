/*
 * AdminTipoParametroParcelario.java
 *
 * Created on 18 de octubre de 2006, 8:55
 * Copyright Trascender SRL
 */
package muni.habilitaciones.grpTipoParametro.ABMTipoParametroParcelario;
 ...
 */
public class AdminTipoParametroParcelario extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Administraci\363n de Par\341metros Parcelarios";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AdminTipoParametroParcelario";
    ...
    private final String lnkAgregar = "AgregarTipoParametroParcelario";
    private final String lnkModificar = "ModificarTipoParametroParcelario";
    private final String lnkEliminar = "EliminarTipoParametroParcelario";
    // </editor-fold>
    ...
    private ObjectListDataProvider ldpTipoParametroParcelario = new ObjectListDataProvider();

    public ObjectListDataProvider getLdpTipoParametroParcelario() {
        return ldpTipoParametroParcelario;
    }

    public void setLdpTipoParametroParcelario(ObjectListDataProvider oldp) {
        this.ldpTipoParametroParcelario = oldp;
    }
 ...
 protected HtmlAjaxCommandButton btnReiniciar = new HtmlAjaxCommandButton();
    ...
    private TableSelectPhaseListener getTableSelectPhaseListener() {
        ...
        return this.getCommunicationHabilitacionesBean().getTablePhaseListenerParametroParcelario();
    }
     ...
     */
    public AdminTipoParametroParcelario() {
    }
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        ...
        ep.getObjetos().add(ind++, new TipoParametroParcelario());
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        TipoParametroParcelario tipoParametroParcelario = (TipoParametroParcelario) this.obtenerObjetoDelElementoPila(0, TipoParametroParcelario.class);

        this.getElementoPila().getObjetos().set(0, tipoParametroParcelario);
    }

    private void mostrarEstadoObjetosUsados() {
        // CAMBIAR: Revisar el metodo completo.
        TipoParametroParcelario tipoParametroParcelario = null;

        tipoParametroParcelario = (TipoParametroParcelario) this.obtenerObjetoDelElementoPila(0, TipoParametroParcelario.class);
        
        if (this.getLdpTipoParametroParcelario().getList() != null){
    ...
    private void refrescarTabla() throws Exception {
        ...
        this.setListaDelCommunication((ArrayList) this.getCommunicationHabilitacionesBean().getRemoteSystemTipoTasa().getListaTiposParametrosParcelarios());
    ...
    private ObjectListDataProvider getObjectListDataProvider() {
        ...
        return this.getLdpTipoParametroParcelario();
    }

    private ArrayList getListaDelCommunication() {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        return this.getCommunicationHabilitacionesBean().getListaTiposParametroParcelario();
    }

    private void setListaDelCommunication(ArrayList lista) {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        this.getCommunicationHabilitacionesBean().setListaTiposParametroParcelario(lista);
    }
    ...
    public String btnSeleccionar_action() {
        ...
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
        if (ultimo) {
            TipoParametro locTipoParametroParcelario = null;
            try {
                ...
                for (int i = 0; i < selectedRowKeys.length; i++) {
                    ...
                    locTipoParametroParcelario = (TipoParametro) obj;
                    this.getRequestBean1().getObjetosSeleccionMultiple().add(locTipoParametroParcelario);
                }
            } catch (Exception ex) {
...
//        return retorno;
    ...
    public String btnExportar_action() {
        ...
        if (ultimo) {
            try {
                JasperPrint jp = ImpresionReporteDinamico.imprimirLista(this.getListaDelCommunication(), this.getTableRowGroup1(), "Reporte Din\341mico de Par\341metros Parcelarios");
                ...
                FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("reportName", "Reporte_ParametrosParcelarios");
