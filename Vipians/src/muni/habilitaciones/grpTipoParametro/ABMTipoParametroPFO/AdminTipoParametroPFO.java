/*
 * AdminTipoParametroPFO.java
 *
 * Created on 18 de octubre de 2006, 8:55
 * Copyright Trascender SRL
 */
package muni.habilitaciones.grpTipoParametro.ABMTipoParametroPFO;
 ...
 */
public class AdminTipoParametroPFO extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Administraci\363n de Par\341metros de PFO";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AdminTipoParametroPFO";
    ...
    private final String lnkAgregar = "AgregarTipoParametroPFO";
    private final String lnkModificar = "ModificarTipoParametroPFO";
    private final String lnkEliminar = "EliminarTipoParametroPFO";
    // </editor-fold>
    ...
    private ObjectListDataProvider ldpTipoParametroPFO = new ObjectListDataProvider();

    public ObjectListDataProvider getLdpTipoParametroPFO() {
        return ldpTipoParametroPFO;
    }

    public void setLdpTipoParametroPFO(ObjectListDataProvider oldp) {
        this.ldpTipoParametroPFO = oldp;
    }
 ...
 protected HtmlAjaxCommandButton btnBuscar = new HtmlAjaxCommandButton();
  ...
  protected HtmlAjaxCommandButton btnReiniciar = new HtmlAjaxCommandButton();
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        ...
        ep.getObjetos().add(ind++, new TipoParametroPFO());
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        TipoParametroPFO tipoParametroPFO = (TipoParametroPFO) this.obtenerObjetoDelElementoPila(0, TipoParametroPFO.class);

        this.getElementoPila().getObjetos().set(0, tipoParametroPFO);
    }

    private void mostrarEstadoObjetosUsados() {
        // CAMBIAR: Revisar el metodo completo.
        TipoParametroPFO tipoParametroPFO = null;

        tipoParametroPFO = (TipoParametroPFO) this.obtenerObjetoDelElementoPila(0, TipoParametroPFO.class);
        
        if (this.getLdpTipoParametroPFO().getList() != null){
    ...
    private void refrescarTabla() throws Exception {
        ...
        this.setListaDelCommunication((ArrayList) this.getCommunicationHabilitacionesBean().getRemoteSystemTipoTasa().getListaTiposParametrosPFO());
    ...
    private ObjectListDataProvider getObjectListDataProvider() {
        ...
        return this.getLdpTipoParametroPFO();
    }

    private ArrayList getListaDelCommunication() {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        return this.getCommunicationHabilitacionesBean().getListaTiposParametroPFO();
    }

    private void setListaDelCommunication(ArrayList lista) {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        this.getCommunicationHabilitacionesBean().setListaTiposParametroPFO(lista);
    }
    ...
    public String btnSeleccionar_action() {
        ...
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
        if (ultimo) {
            TipoParametro locTipoParametroPFO = null;
            try {
                ...
                for (int i = 0; i < selectedRowKeys.length; i++) {
                    ...
                    locTipoParametroPFO = (TipoParametro) obj;
                    this.getRequestBean1().getObjetosSeleccionMultiple().add(locTipoParametroPFO);
                }
            } catch (Exception ex) {
...
//        return retorno;
    ...
    public String btnExportar_action() {
        ...
        if (ultimo) {
            try {
                JasperPrint jp = ImpresionReporteDinamico.imprimirLista(this.getListaDelCommunication(), this.getTableRowGroup1(), "Reporte Din\341mico de Par\341metros PFO");
                ...
                FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("reportName", "Reporte_ParametrosPFO");
