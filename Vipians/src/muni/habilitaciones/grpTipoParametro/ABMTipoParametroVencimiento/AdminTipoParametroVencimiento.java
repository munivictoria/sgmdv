/*
 * AdminTipoParametroVencimiento.java
 *
 * Created on 18 de octubre de 2006, 8:55
 * Copyright Trascender SRL
 */
package muni.habilitaciones.grpTipoParametro.ABMTipoParametroVencimiento;
 ...
 */
public class AdminTipoParametroVencimiento extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Administraci\363n de Par\341metros de Vencimientos";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AdminTipoParametroVencimiento";
    ...
    private final String lnkAgregar = "AgregarTipoParametroVencimiento";
    private final String lnkModificar = "ModificarTipoParametroVencimiento";
    private final String lnkEliminar = "EliminarTipoParametroVencimiento";
    // </editor-fold>
    ...
    private ObjectListDataProvider ldpTipoParametroVencimiento = new ObjectListDataProvider();

    public ObjectListDataProvider getLdpTipoParametroVencimiento() {
        return ldpTipoParametroVencimiento;
    }

    public void setLdpTipoParametroVencimiento(ObjectListDataProvider oldp) {
        this.ldpTipoParametroVencimiento = oldp;
    }
 ...
 protected HtmlAjaxCommandButton btnReiniciar = new HtmlAjaxCommandButton();
    ...
    private TableSelectPhaseListener getTableSelectPhaseListener() {
        ...
        return this.getCommunicationHabilitacionesBean().getTablePhaseListenerParametroVencimiento();
    }
     ...
     */
    public AdminTipoParametroVencimiento() {
    }
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        ...
        ep.getObjetos().add(ind++, new TipoParametroVencimiento());
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        TipoParametroVencimiento tipoParametroVencimiento = (TipoParametroVencimiento) this.obtenerObjetoDelElementoPila(0, TipoParametroVencimiento.class);

        this.getElementoPila().getObjetos().set(0, tipoParametroVencimiento);
    }

    private void mostrarEstadoObjetosUsados() {
        // CAMBIAR: Revisar el metodo completo.
        TipoParametroVencimiento tipoParametroVencimiento = null;

        tipoParametroVencimiento = (TipoParametroVencimiento) this.obtenerObjetoDelElementoPila(0, TipoParametroVencimiento.class);
        
        if (this.getLdpTipoParametroVencimiento().getList() != null){
    ...
    private void refrescarTabla() throws Exception {
        ...
        this.setListaDelCommunication((ArrayList) this.getCommunicationHabilitacionesBean().getRemoteSystemTipoTasa().getListaTiposParametrosVencimiento());
    ...
    private ObjectListDataProvider getObjectListDataProvider() {
        ...
        return this.getLdpTipoParametroVencimiento();
    }

    private ArrayList getListaDelCommunication() {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        return this.getCommunicationHabilitacionesBean().getListaTiposParametroVencimiento();
    }

    private void setListaDelCommunication(ArrayList lista) {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        this.getCommunicationHabilitacionesBean().setListaTiposParametroVencimiento(lista);
    }
    ...
    public String btnSeleccionar_action() {
        ...
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
        if (ultimo) {
            TipoParametro locTipoParametroVencimiento = null;
            try {
                ...
                for (int i = 0; i < selectedRowKeys.length; i++) {
                    ...
                    locTipoParametroVencimiento = (TipoParametro) obj;
                    this.getRequestBean1().getObjetosSeleccionMultiple().add(locTipoParametroVencimiento);
                }
            } catch (Exception ex) {
...
//        return retorno;
    ...
    public String btnExportar_action() {
        ...
        if (ultimo) {
            try {
                JasperPrint jp = ImpresionReporteDinamico.imprimirLista(this.getListaDelCommunication(), this.getTableRowGroup1(), "Reporte Din\341mico de Par\341metros de Vencimientos");

                FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("reportName", "Reporte_ParametrosVencimientos");
