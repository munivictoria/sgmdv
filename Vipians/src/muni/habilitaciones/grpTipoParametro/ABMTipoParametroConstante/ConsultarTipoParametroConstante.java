 ...
 */
public class ConsultarTipoParametroConstante extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Consultar Par\341metro Constante";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ConsultarTipoParametroConstante";
     ...
     */
    public ConsultarTipoParametroConstante() {
    }
...
//            this.cargarValoresPorDefecto();
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        if (tipoParametroConstante.getValor() != null) this.getTfValor().setText(valor.toString());
