/*
 * EliminarTipoParametroConstante.java
 *
 ...
 */
public class EliminarTipoParametroConstante extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Eliminar Par\341metro Constante";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EliminarTipoParametroConstante";
     ...
     */
    public EliminarTipoParametroConstante() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("EliminarTipoParametroConstante Initialization Failure", e);
    ...
    public String btnEliminar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getCommunicationHabilitacionesBean().getRemoteSystemTipoTasa().deleteTipoParametroConstante(tipoParametroConstante);
                
                this.getRequestBean1().setRespuestaABM(tipoParametroConstante);
                info("El Par\341metro Constante se elimin\363 exitosamente.");
