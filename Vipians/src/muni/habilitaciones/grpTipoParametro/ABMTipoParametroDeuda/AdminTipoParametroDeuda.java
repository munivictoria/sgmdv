package muni.habilitaciones.grpTipoParametro.ABMTipoParametroDeuda;
...
public class AdminTipoParametroDeuda extends AbstractPageBean{
    ...
    private final String NOMBRE_PAGINA = "Administraci\363n de Par\341metros de Deuda";
    private final String CASO_NAVEGACION = "AdminTipoParametroDeuda";
    private final String CASO_NAV_CADUCIDAD = "PaginaCaducidad";
    private final String CASO_NAV_POST_CADUCIDAD = "Main";
    private final boolean PUEDE_SER_PAGINA_INICIAL = true;
    private final String lnkAgregar = "AgregarTipoParametroDeuda";
    private final String lnkModificar = "ModificarTipoParametroDeuda";
    private final String lnkEliminar = "EliminarTipoParametroDeuda";
    ...
    private ObjectListDataProvider ldpTipoParametroDeuda = new ObjectListDataProvider();
    
    public ObjectListDataProvider getLdpTipoParametroDeuda() {
		return ldpTipoParametroDeuda;
	}

	public void setLdpTipoParametroDeuda(ObjectListDataProvider ldpTipoParametroDeuda) {
		this.ldpTipoParametroDeuda = ldpTipoParametroDeuda;
	}
...
protected HtmlAjaxCommandButton btnReiniciar = new HtmlAjaxCommandButton();
    ...
    private TableSelectPhaseListener getTableSelectPhaseListener() {
        return this.getCommunicationHabilitacionesBean().getTablePhaseListenerParametroDeuda();
    }

    public AdminTipoParametroDeuda() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("AdminTipoParametroDeuda Initialization Failure", e);
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        int ind = 0;
        ep.getObjetos().add(ind++, new String()); // para saber si es TipoParametroDeuda/

        return ep;
    }

    private void guardarEstadoObjetosUsados() {
    	String tipoParametroDeuda = (String) this.obtenerObjetoDelElementoPila(0, String.class);

        this.getElementoPila().getObjetos().set(0, tipoParametroDeuda);
    }
    ...
    private void mostrarEstadoObjetosUsados() {
    	...
    	if (this.getRequestBean1().getObjetoSeleccion() != null) {
    		tipoParametroDeuda = (String) this.getRequestBean1().getObjetoSeleccion().toString();
            this.getElementoPila().getObjetos().set(0, tipoParametroDeuda);
        }
    	
        if (this.getLdpTipoParametroDeuda().getList() != null){
        ...
        try {
            ...
            Logger.getLogger(AdminTipoParametroDeuda.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void refrescarTabla() throws Exception {
    	...
    	if (tipoParametroDeuda != null && tipoParametroDeuda != "") {
    		
    		this.setListaDelCommunication((ArrayList) this.getCommunicationHabilitacionesBean().getRemoteSystemTipoTasa().getListaTiposParametrosDeuda());
    ...
    private ObjectListDataProvider getObjectListDataProvider() {
        ...
        return this.getLdpTipoParametroDeuda();
    }

    private List getListaDelCommunication() {
        return this.getCommunicationHabilitacionesBean().getListaTiposParametroDeuda();
    }

    private void setListaDelCommunication(List lista) {
        this.getCommunicationHabilitacionesBean().setListaTiposParametroDeuda(lista);
    }
    ...
    public String btnSeleccionar_action() {
        ...
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
        if (ultimo) {
        	Object locTipoParametroDeuda = null;
            ...
            try {
                ...
                for (int i = 0; i < selectedRowKeys.length; i++) {
                    ...
                    if (tipoSeleccionado != null && tipoSeleccionado != "") {
                        locTipoParametroDeuda = (TipoParametro) obj;
                        this.getRequestBean1().getObjetosSeleccionMultiple().add(locTipoParametroDeuda);
                    }
                }
            } catch (Exception ex) {
    ...
    public String btnExportar_action() {
        ...
        if (ultimo) {
            try {
                JasperPrint jp = ImpresionReporteDinamico.imprimirLista(this.getListaDelCommunication(), this.getTableRowGroup1(), "Reporte Din\341mico de Par\341metros Deuda");
                ...
                FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("reportName", "Reporte_ParametrosDeuda");
