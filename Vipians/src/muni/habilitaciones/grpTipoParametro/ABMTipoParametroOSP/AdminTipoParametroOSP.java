/*
 * AdminTipoParametroOSP.java
 *
 * Created on 18 de octubre de 2006, 8:55
 * Copyright Trascender SRL
 */
package muni.habilitaciones.grpTipoParametro.ABMTipoParametroOSP;
...
import com.trascender.framework.test.ejb3.TestParametro;
 ...
 */
public class AdminTipoParametroOSP extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Administraci\363n de Par\341metros de OSP";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AdminTipoParametroOSP";
    ...
    private final String lnkAgregar = "AgregarTipoParametroOSP";
    private final String lnkModificar = "ModificarTipoParametroOSP";
    private final String lnkEliminar = "EliminarTipoParametroOSP";
    // </editor-fold>
    ...
    private ObjectListDataProvider ldpTipoParametroOSP = new ObjectListDataProvider();

    public ObjectListDataProvider getLdpTipoParametroOSP() {
        return ldpTipoParametroOSP;
    }

    public void setLdpTipoParametroOSP(ObjectListDataProvider oldp) {
        this.ldpTipoParametroOSP = oldp;
    }
 ...
 protected HtmlAjaxCommandButton btnReiniciar = new HtmlAjaxCommandButton();
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        ...
        try {
            ep.getObjetos().add(ind++, new TipoParametroOSP());
        } catch (Exception ex) {
        }
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        TipoParametroOSP tipoParametroOSP = (TipoParametroOSP) this.obtenerObjetoDelElementoPila(0, TipoParametroOSP.class);

        this.getElementoPila().getObjetos().set(0, tipoParametroOSP);
    }

    private void mostrarEstadoObjetosUsados() {
        // CAMBIAR: Revisar el metodo completo.
        TipoParametroOSP tipoParametroOSP = null;

        tipoParametroOSP = (TipoParametroOSP) this.obtenerObjetoDelElementoPila(0, TipoParametroOSP.class);
        
        if (this.getLdpTipoParametroOSP().getList() != null){
    ...
    private void refrescarTabla() throws Exception {
        ...
        this.setListaDelCommunication((ArrayList) this.getCommunicationHabilitacionesBean().getRemoteSystemTipoTasa().getListaTiposParametrosOSP());
    ...
    private ObjectListDataProvider getObjectListDataProvider() {
        ...
        return this.getLdpTipoParametroOSP();
    }

    private ArrayList getListaDelCommunication() {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        return this.getCommunicationHabilitacionesBean().getListaTiposParametroOSP();
    }

    private void setListaDelCommunication(ArrayList lista) {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        this.getCommunicationHabilitacionesBean().setListaTiposParametroOSP(lista);
    }
    ...
    public String btnSeleccionar_action() {
        ...
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
        if (ultimo) {
            TipoParametro locTipoParametroOSP = null;
            ...
            try {
                ...
                for (int i = 0; i < selectedRowKeys.length; i++) {
                    ...
                    locTipoParametroOSP = (TipoParametro) obj;
                    this.getRequestBean1().getObjetosSeleccionMultiple().add(locTipoParametroOSP);
                }
            } catch (Exception ex) {
...
//        return retorno;
    ...
    public String btnExportar_action() {
        ...
        if (ultimo) {
            try {
                JasperPrint jp = ImpresionReporteDinamico.imprimirLista(this.getListaDelCommunication(), this.getTableRowGroup1(), "Reporte Din\341mico de Par\341metros OSP");
                ...
                FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("reportName", "Reporte_ParametrosOSP");
