/*
 * AdminTipoParametroObra.java
 *
 * Created on 18 de octubre de 2006, 8:55
 * Copyright Trascender SRL
 */
package muni.habilitaciones.grpTipoParametro.ABMTipoParametroObra;
 ...
 */
public class AdminTipoParametroObra extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Administraci\363n de Par\341metros de Obra";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AdminTipoParametroObra";
    ...
    private final String lnkAgregar = "AgregarTipoParametroObra";
    private final String lnkModificar = "ModificarTipoParametroObra";
    private final String lnkEliminar = "EliminarTipoParametroObra";
    // </editor-fold>
    ...
    private ObjectListDataProvider ldpTipoParametroObra = new ObjectListDataProvider();

    public ObjectListDataProvider getLdpTipoParametroObra() {
        return ldpTipoParametroObra;
    }

    public void setLdpTipoParametroObra(ObjectListDataProvider oldp) {
        this.ldpTipoParametroObra = oldp;
    }
 ...
 protected HtmlAjaxCommandButton btnReiniciar = new HtmlAjaxCommandButton();
    ...
    private TableSelectPhaseListener getTableSelectPhaseListener() {
        ...
        return this.getCommunicationHabilitacionesBean().getTablePhaseListenerParametroObra();
    }
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) throws Exception {
        int ind = 0;
        try {
            //CAMBIAR: settear los objetos administrados por la pagina
            ep.getObjetos().add(ind++, new TipoParametroObra());
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        TipoParametroObra tipoParametroObra = (TipoParametroObra) this.obtenerObjetoDelElementoPila(0, TipoParametroObra.class);

        this.getElementoPila().getObjetos().set(0, tipoParametroObra);
    }

    private void mostrarEstadoObjetosUsados() {
        // CAMBIAR: Revisar el metodo completo.
        TipoParametroObra tipoParametroObra = null;

        tipoParametroObra = (TipoParametroObra) this.obtenerObjetoDelElementoPila(0, TipoParametroObra.class);
        
        if (this.getLdpTipoParametroObra().getList() != null){
    ...
    private void refrescarTabla() throws Exception {
        ...
        this.setListaDelCommunication((ArrayList) this.getCommunicationHabilitacionesBean().getRemoteSystemTipoTasa().getListaTiposParametrosObra());
    ...
    private ObjectListDataProvider getObjectListDataProvider() {
        ...
        return this.getLdpTipoParametroObra();
    }

    private ArrayList getListaDelCommunication() {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        return this.getCommunicationHabilitacionesBean().getListaTiposParametroObra();
    }

    private void setListaDelCommunication(ArrayList lista) {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        this.getCommunicationHabilitacionesBean().setListaTiposParametroObra(lista);
    }

    // </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Metodos estaticos de la pagina">
    private void crearElementoPila() throws Exception {
    ...
    public String btnSeleccionar_action() {
        ...
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
        if (ultimo) {
            TipoParametro locTipoParametroObra = null;
            try {
                ...
                for (int i = 0; i < selectedRowKeys.length; i++) {
                    ...
                    locTipoParametroObra = (TipoParametro) obj;
                    this.getRequestBean1().getObjetosSeleccionMultiple().add(locTipoParametroObra);
                }
            } catch (Exception ex) {
...
//        return retorno;
    ...
    public String btnExportar_action() {
        ...
        if (ultimo) {
            try {
                JasperPrint jp = ImpresionReporteDinamico.imprimirLista(this.getListaDelCommunication(), this.getTableRowGroup1(), "Reporte Din\341mico de Par\341metros de Obra");
                ...
                FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("reportName", "Reporte_ParametrosObra");
