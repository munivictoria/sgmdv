 ...
 */
public class AdminPermisoSinFirma extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Administraci\363n de Permisos Pendientes de Firma";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AdminPermisoSinFirma";
    ...
    private final String lnkConsultarSHPS = "ConsultarPermisoSinFirmaSHPS";
    private final String lnkConsultarPFO = "ConsultarPermisoSinFirmaPFO";
    private final String lnkConsultarTGI = "ConsultarPermisoSinFirmaTGI";
    private final String lnkConsultarOSP = "ConsultarPermisoSinFirmaOSP";
    // </editor-fold>
 ...
 protected HtmlAjaxCommandButton btnBuscar = new HtmlAjaxCommandButton();
    ...
    public void setLblPersona(Label l) {
        this.lblPersona = l;
    }
    ...
    public void setTfPersonaFisica(TextField tfPersonaFisica) {
        this.tfPersonaFisica = tfPersonaFisica;
    }
    ...
    private Button btnConsultarObligacion = new Button();

    public Button getBtnConsultarObligacion() {
        return btnConsultarObligacion;
    }

    public void setBtnConsultarObligacion(Button b) {
        this.btnConsultarObligacion = b;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("AdminPermisoSinFirma Initialization Failure", e);
...
//        ep.getObjetos().add(ind++, null); //Persona F o J
//        ep.getObjetos().add(ind++, new Integer(0));
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        if (persona != null) {
            this.getTfPersonaFisica().setText(persona.toString());
        }
    ...
    private void refrescarTabla() throws Exception {
        ...
        if (persona != null) {
            this.setListaDelCommunication((ArrayList) this.getCommunicationHabilitacionesBean().getRemoteSystemObligacion().findListaPermisosHabAFirmar(persona));
        } else {
            Obligacion obligacion = null;
            this.setListaDelCommunication((ArrayList) this.getCommunicationHabilitacionesBean().getRemoteSystemObligacion().findListaPermisosHabAFirmar(obligacion));
        }
    ...
    private ArrayList getListaDelCommunication() {
        ...
        return this.getCommunicationHabilitacionesBean().getListaPermisosSinFirmar();
    }

    private void setListaDelCommunication(ArrayList lista) {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        this.getCommunicationHabilitacionesBean().setListaPermisosSinFirmar(lista);
    }
    ...
    public String btnSeleccionarPersonaJuridica_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                // CAMBIAR:
                log(CASO_NAVEGACION + "_SeleccionarPropietarioError:", ex);
                error(NOMBRE_PAGINA + " - Seleccionar Propietario: " + ex.getMessage());
            }
    ...
    public String btnConsultarObligacion_action() {
        String retorno = null;
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
        ...
        if (ultimo) {
            ...
            try {
                ...
                if (rk != null) {
                    ...
                    PermisoHab permisoHab = (PermisoHab) obj;
                    Obligacion obligacion = (Obligacion) permisoHab.getObligacion();
                    this.getCommunicationHabilitacionesBean().getRemoteSystemObligacion().setLlave(this.getSessionBean1().getLlave());
                ...
                log(CASO_NAVEGACION + "_ConsultarObligacionError:", ex);
                error(NOMBRE_PAGINA + " - Consultar Obligaci\363n: " + ex.getMessage());
            }
            ...
            if (obj != null) {
                ...
                try {
                    PermisoHab permisoHab = (PermisoHab) obj;
                    this.getCommunicationHabilitacionesBean().getRemoteSystemObligacion().setLlave(this.getSessionBean1().getLlave());
                    tipoObligacion = this.getCommunicationHabilitacionesBean().getRemoteSystemObligacion().getTipoObligacionFromObligacion(permisoHab.getObligacion());
                } catch (Exception ex) {
                    log(CASO_NAVEGACION + "_getTipoObligacionFromObligacion:", ex);
                    error(NOMBRE_PAGINA + " - No se pudo obtener el Tipo de Obligaci\363n: " + ex.getMessage());
                }
                
                if (tipoObligacion.getNombre().equals("SHPS")) {
                    retorno = lnkConsultarSHPS;
                } else if (tipoObligacion.getNombre().equals("OYSP")) {
                    retorno = lnkConsultarOSP;
                } else if (tipoObligacion.getNombre().equals("PLAN_FINANCIACION_OBRA")) {
                    retorno = lnkConsultarPFO;
                } else if (tipoObligacion.getNombre().equals("TGI")) {
                    retorno = lnkConsultarTGI;
                }
            }
    ...
    public String btnExportar_action() {
        ...
        if (ultimo) {
            try {
                JasperPrint jp = ImpresionReporteDinamico.imprimirLista(this.getListaDelCommunication(), this.getTableRowGroup1(), "Reporte Din\341mico de Permisos Pendientes de Firma");
                ...
                FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("reportName", "Reporte_PermisosPendientesFirma");
