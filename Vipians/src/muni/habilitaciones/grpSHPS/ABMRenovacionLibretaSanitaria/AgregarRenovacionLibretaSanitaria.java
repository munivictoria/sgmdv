 ...
 */
package muni.habilitaciones.grpSHPS.ABMRenovacionLibretaSanitaria;
 ...
 */
public class AgregarRenovacionLibretaSanitaria extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Agregar Renovaci\363n de Libreta Sanitaria";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AgregarRenovacionLibretaSanitaria";
    ...
    private TextField tfFechaVigencia = new TextField();

    public TextField getTfFechaVigencia() {
        return tfFechaVigencia;
    }

    public void setTfFechaVigencia(TextField tf) {
        this.tfFechaVigencia = tf;
    }
     ...
     */
    public AgregarRenovacionLibretaSanitaria() {
    }
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        ...
        ep.getObjetos().add(ind++, new RenovacionLibretaSanitaria());
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        int ind = 0;
        RenovacionLibretaSanitaria renovacionLibretaSanitaria = (RenovacionLibretaSanitaria) this.obtenerObjetoDelElementoPila(ind++, RenovacionLibretaSanitaria.class);
        ...
        Object fechaVigencia = this.getTfFechaVigencia().getText(); 
        
        if (fechaDesde != null && fechaDesde != "") renovacionLibretaSanitaria.setFechaDesde(Conversor.getFechaCortaDeString(fechaDesde.toString())); else renovacionLibretaSanitaria.setFechaDesde(null);
        if (fechaVigencia != null && fechaVigencia != "") renovacionLibretaSanitaria.setFechaVigencia(Conversor.getFechaCortaDeString(fechaVigencia.toString())); else renovacionLibretaSanitaria.setFechaVigencia(null);
        
        ind = 0;
        this.getElementoPila().getObjetos().set(ind++, renovacionLibretaSanitaria);
        this.getElementoPila().getObjetos().set(ind++, libretaSanitaria);
    }
    
    private void mostrarEstadoObjetosUsados() {
        // CAMBIAR: Revisar el metodo completo.
        RenovacionLibretaSanitaria renovacionLibretaSanitaria = null;
        ...
        int ind = 0;
        renovacionLibretaSanitaria = (RenovacionLibretaSanitaria) this.obtenerObjetoDelElementoPila(ind++, RenovacionLibretaSanitaria.class);
        ...
        this.getTfFechaDesde().setText(Conversor.getStringDeFechaCorta(renovacionLibretaSanitaria.getFechaDesde()));
        this.getTfFechaVigencia().setText(Conversor.getStringDeFechaCorta(renovacionLibretaSanitaria.getFechaVigencia()));
    }
    // </editor-fold>
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                int pos = 0;
                noVacios[pos] = this.getTfFechaDesde();
                nomNoVacios[pos++] = "Fecha Renovaci\363n";
                noVacios[pos] = this.getTfFechaVigencia();
                nomNoVacios[pos++] = "Fecha Vigencia";

                pos = 0;
                fechas[pos] = this.getTfFechaDesde();
                nomFechas[pos++] = "Fecha Renovaci\363n";
                fechas[pos] = this.getTfFechaVigencia();
                nomFechas[pos++] = "Fecha Vigencia";                
                ...
                // CAMBIAR:
                RenovacionLibretaSanitaria renovacionLibretaSanitaria = (RenovacionLibretaSanitaria) this.obtenerObjetoDelElementoPila(0, RenovacionLibretaSanitaria.class);

                if(!v.fechaNoMayorAFechaActual(renovacionLibretaSanitaria.getFechaDesde(), "Fecha de Vigencia")){
                    this.getTfFechaDesde().setValid(false);
                }
                ...
                this.getRequestBean1().setRespuestaABM(renovacionLibretaSanitaria);
