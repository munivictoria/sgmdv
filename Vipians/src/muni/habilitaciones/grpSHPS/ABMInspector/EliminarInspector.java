 ...
 */
public class EliminarInspector extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Eliminar Inspector";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EliminarInspector";
    ...
    public void init() {
        ...
        try {
            ...
            log("EliminarInspector Initialization Failure", e);
    ...
    public String btnEliminar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getCommunicationHabilitacionesBean().getRemoteSystemInspectores().deleteInspector(inspector);
                
                this.getRequestBean1().setRespuestaABM(inspector);
                
                info("El Inspector se elimin\363 exitosamente.");
