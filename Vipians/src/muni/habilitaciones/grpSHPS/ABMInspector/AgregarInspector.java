 ...
 */
public class AgregarInspector extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("AgregarInspector Initialization Failure", e);
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getCommunicationHabilitacionesBean().getRemoteSystemInspectores().addInspector(inspector);
                
                this.getRequestBean1().setRespuestaABM(inspector);
                
                info("El Inspector se agreg\363 exitosamente.");
