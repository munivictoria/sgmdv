 ...
 */
public class ModificarInspector extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Modificar Inspector";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ModificarInspector";
    ...
    public void init() {
        ...
        try {
            ...
            log("ModificarInspector Initialization Failure", e);
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        if (this.getRequestBean1().getObjetoABM() != null) {
            inspector = (Inspector) this.getRequestBean1().getObjetoABM();
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getCommunicationHabilitacionesBean().getRemoteSystemInspectores().updateInspector(inspector);
                
                this.getRequestBean1().setRespuestaABM(inspector);
                
                info("El Inspector se modific\363 exitosamente.");
