 ...
 */
public class ConsultarInspector extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Consultar Inspector";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ConsultarInspector";
