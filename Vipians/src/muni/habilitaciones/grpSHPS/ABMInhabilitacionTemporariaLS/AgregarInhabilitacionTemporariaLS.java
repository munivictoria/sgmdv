/*
 * AgregarInhabilitacionTemporariaLS.java
 *
 * Created on 24 de octubre de 2006, 10:40
 * Copyright Trascender SRL
 */
package muni.habilitaciones.grpSHPS.ABMInhabilitacionTemporariaLS;
 ...
 */
public class AgregarInhabilitacionTemporariaLS extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Agregar Inhabilitaci\363n Temporaria de Libreta Sanitaria";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AgregarInhabilitacionTemporariaLS";
    ...
    private TextField tfFechaInhabilitacion = new TextField();

    public TextField getTfFechaInhabilitacion() {
        return tfFechaInhabilitacion;
    }

    public void setTfFechaInhabilitacion(TextField tf) {
        this.tfFechaInhabilitacion = tf;
    }
    ...
    private TextField tfFechaReintegro = new TextField();

    public TextField getTfFechaReintegro() {
        return tfFechaReintegro;
    }

    public void setTfFechaReintegro(TextField tf) {
        this.tfFechaReintegro = tf;
    }
    ...
    private TextField tfDiagnostico = new TextField();

    public TextField getTfDiagnostico() {
        return tfDiagnostico;
    }

    public void setTfDiagnostico(TextField tf) {
        this.tfDiagnostico = tf;
    }
    ...
    private TextField tfPruebaConfirmatoria = new TextField();

    public TextField getTfPruebaConfirmatoria() {
        return tfPruebaConfirmatoria;
    }

    public void setTfPruebaConfirmatoria(TextField tf) {
        this.tfPruebaConfirmatoria = tf;
    }
    // </editor-fold>
     ...
     */
    public AgregarInhabilitacionTemporariaLS() {
    }
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        ...
        ep.getObjetos().add(ind++, new InhabilitacionTemporariaLS());
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        int ind = 0;
        InhabilitacionTemporariaLS inhabilitacionTemporariaLS = (InhabilitacionTemporariaLS) this.obtenerObjetoDelElementoPila(ind++, InhabilitacionTemporariaLS.class);
        LibretaSanitaria libretaSanitaria = (LibretaSanitaria) this.obtenerObjetoDelElementoPila(ind++, LibretaSanitaria.class);
        
        Object fechaInhabilitacion = this.getTfFechaInhabilitacion().getText();
        Object diagnostico = this.getTfDiagnostico().getText();
        Object pruebaConfirmatoria = this.getTfPruebaConfirmatoria().getText();
        Object fechaReintegro = this.getTfFechaReintegro().getText(); 
        
        if (fechaInhabilitacion != null && fechaInhabilitacion != "") inhabilitacionTemporariaLS.setFechaInhabilitacion(Conversor.getFechaCortaDeString(fechaInhabilitacion.toString())); else inhabilitacionTemporariaLS.setFechaInhabilitacion(null);
        if (diagnostico != null && diagnostico != "") inhabilitacionTemporariaLS.setDiagnostico(diagnostico.toString()); else inhabilitacionTemporariaLS.setDiagnostico(null);
        if (pruebaConfirmatoria != null && pruebaConfirmatoria != "") inhabilitacionTemporariaLS.setPruebaConfirmatoria(pruebaConfirmatoria.toString()); else inhabilitacionTemporariaLS.setPruebaConfirmatoria(null);        
        if (fechaReintegro != null && fechaReintegro != "") inhabilitacionTemporariaLS.setFechaReintegro(Conversor.getFechaCortaDeString(fechaReintegro.toString())); else inhabilitacionTemporariaLS.setFechaReintegro(null);
        
        inhabilitacionTemporariaLS.setLibretaSanitaria(libretaSanitaria);
        
        ind = 0;
        this.getElementoPila().getObjetos().set(ind++, inhabilitacionTemporariaLS);
        this.getElementoPila().getObjetos().set(ind++, libretaSanitaria);
    }
    
    private void mostrarEstadoObjetosUsados() {
        // CAMBIAR: Revisar el metodo completo.
        InhabilitacionTemporariaLS inhabilitacionTemporariaLS = null;
        ...
        if (this.getRequestBean1().getObjetoABM() != null) {
            inhabilitacionTemporariaLS = (InhabilitacionTemporariaLS) this.getRequestBean1().getObjetoABM();
            this.getElementoPila().getObjetos().set(0, inhabilitacionTemporariaLS);
        }
        
        int ind = 0;
        inhabilitacionTemporariaLS = (InhabilitacionTemporariaLS) this.obtenerObjetoDelElementoPila(ind++, InhabilitacionTemporariaLS.class);
        ...
        this.getTfFechaInhabilitacion().setText(Conversor.getStringDeFechaCorta(inhabilitacionTemporariaLS.getFechaInhabilitacion()));
        this.getTfDiagnostico().setText(inhabilitacionTemporariaLS.getDiagnostico());
        this.getTfPruebaConfirmatoria().setText(inhabilitacionTemporariaLS.getPruebaConfirmatoria());
        this.getTfFechaReintegro().setText(Conversor.getStringDeFechaCorta(inhabilitacionTemporariaLS.getFechaReintegro()));
    }
    // </editor-fold>
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                int pos = 0;
                noVacios[pos] = this.getTfFechaInhabilitacion();
                nomNoVacios[pos++] = "Fecha Inhabilitaci\363n";
                noVacios[pos] = this.getTfDiagnostico();
                nomNoVacios[pos++] = "Diagn\363stico"; 
                noVacios[pos] = this.getTfFechaReintegro();
                nomNoVacios[pos++] = "Fecha Reintegro";

                pos = 0;
                fechas[pos] = this.getTfFechaInhabilitacion();
                nomFechas[pos++] = "Fecha Inhabilitaci\363n";
                fechas[pos] = this.getTfFechaReintegro();
                nomFechas[pos++] = "Fecha Reintegro";
                
                v.noSonVacios(noVacios, nomNoVacios);
                v.formatoFechaValido(fechas, nomFechas);
                
                // CAMBIAR:
                InhabilitacionTemporariaLS inhabilitacionTemporariaLS = (InhabilitacionTemporariaLS) this.obtenerObjetoDelElementoPila(0, InhabilitacionTemporariaLS.class);

                if(!v.fechaNoMayorAFechaActual(inhabilitacionTemporariaLS.getFechaInhabilitacion(), "Fecha de Inhabilitación")){
                    this.getTfFechaInhabilitacion().setValid(false);
                }
                ...
                this.getRequestBean1().setRespuestaABM(inhabilitacionTemporariaLS);
