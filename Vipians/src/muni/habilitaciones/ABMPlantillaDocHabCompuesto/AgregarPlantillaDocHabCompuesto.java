/*
 * AgregarPlantillaDocHabCompuesto.java
 *
 * Created on 17 de noviembre de 2006, 11:27
 * Copyright Trascender
 */
package muni.habilitaciones.ABMPlantillaDocHabCompuesto;
 ...
 */
public class AgregarPlantillaDocHabCompuesto extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Agregar Documento Compuesto";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AgregarPlantillaDocHabCompuesto";
     ...
     */
    public AgregarPlantillaDocHabCompuesto() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("AgregarPlantillaDocHabCompuesto Initialization Failure", e);
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        ...
        ep.getObjetos().add(ind++, new PlantillaDocHabCompuesto());
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        PlantillaDocHabCompuesto docComp = (PlantillaDocHabCompuesto) this.obtenerObjetoDelElementoPila(0, PlantillaDocHabCompuesto.class);
        
        Object nombre = this.getTfNombre().getText();
        Object descrip = this.getTaDescripcion().getText();
        
        if (nombre != null && nombre != "") docComp.setNombre(nombre.toString()); else docComp.setNombre(null);
        if (descrip != null && descrip != "") docComp.setDescripcion(descrip.toString()); else docComp.setDescripcion(null);
        
        this.getElementoPila().getObjetos().set(0, docComp);
    }
    
    private void mostrarEstadoObjetosUsados() {
        // CAMBIAR: Crear una instancia por cada objeto manejado en la pagina
        PlantillaDocHabCompuesto docComp = null;
        String padre = null;
        
        // CAMBIAR: Obtener datos del Request y asignarlos a los textField
        if (this.getRequestBean1().getObjetoABM() != null) {
            System.out.println("entro en get Objeto ABM;");
            docComp = (PlantillaDocHabCompuesto) this.getRequestBean1().getObjetoABM();
            this.getElementoPila().getObjetos().set(0, docComp);
        }
        
        if (this.getRequestBean1().getObjetoSeleccion() != null) {
            System.out.println("entro en get ObjetoSeleccion;");
        ...
        docComp = (PlantillaDocHabCompuesto) this.obtenerObjetoDelElementoPila(0, PlantillaDocHabCompuesto.class);
        padre =  (String) this.obtenerObjetoDelElementoPila(1, String.class);
        
        this.getTfPadre().setText(padre);
        this.getTfNombre().setText(docComp.getNombre());
        this.getTaDescripcion().setText(docComp.getDescripcion());
    }
    // </editor-fold>
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                // CAMBIAR:
                Object docHabComp = this.getElementoPila().getObjetos().get(0);
                this.getRequestBean1().setRespuestaABM(docHabComp);
                
                info("Se agreg\363 un Documento Compuesto.");
