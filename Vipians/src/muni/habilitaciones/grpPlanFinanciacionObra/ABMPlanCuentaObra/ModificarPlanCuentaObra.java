 ...
 */
public class ModificarPlanCuentaObra extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Modificar Plan de Cuenta para Obras";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ModificarPlanCuentaObra";
     ...
     */
    public ModificarPlanCuentaObra() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("ModificarPlanCuentaObra Initialization Failure", e);
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                planCuentaObra = this.getCommunicationHabilitacionesBean().getRemoteSystemPlanFinanciacionObra().updatePlanCuentaObra(planCuentaObra);
                this.getRequestBean1().setRespuestaABM(planCuentaObra);
                
                info("El Plan de Cuenta para Obras se modific\363 exitosamente.");
