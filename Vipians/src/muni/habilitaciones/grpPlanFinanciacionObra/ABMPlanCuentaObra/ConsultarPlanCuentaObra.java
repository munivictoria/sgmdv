 ...
 */
public class ConsultarPlanCuentaObra extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Consultar Plan de Cuenta para Obras";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ConsultarPlanCuentaObra";
     ...
     */
    public ConsultarPlanCuentaObra() {
    }
