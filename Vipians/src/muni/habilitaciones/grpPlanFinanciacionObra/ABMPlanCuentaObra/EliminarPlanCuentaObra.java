 ...
 */
public class EliminarPlanCuentaObra extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Eliminar Plan de Cuenta para Obras";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EliminarPlanCuentaObra";
    ...
    public void init() {
        ...
        try {
            ...
            log("EliminarPlanCuentaObra Initialization Failure", e);
    ...
    public String btnEliminar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getCommunicationHabilitacionesBean().getRemoteSystemPlanFinanciacionObra().deletePlanCuentaObra(planCuentaObra);
                
                this.getRequestBean1().setRespuestaABM(planCuentaObra);
                
                info("El Plan de Cuenta para Obras se elimin\363 exitosamente.");
