 ...
 */
public class EliminarDocEspPFO extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Eliminar Obligaci\363n: PFO";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EliminarDocEspPFO";
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        if (this.getRequestBean1().getObjetoABM() != null) {
            ...
            try {
                ...
                documentoPFO.setObligacion(obligacion);
            } catch (Exception ex) {
        ...
        if (ultimo) {
            ...
            try {
               ...
               /* Validador v = new Validador();
                ...
                documentoPFO.getObligacion().anular();
                this.getCommunicationHabilitacionesBean().getRemoteSystemObligacion().setLlave(this.getSessionBean1().getLlave());
                this.getCommunicationHabilitacionesBean().getRemoteSystemObligacion().updateObligacion(documentoPFO.getObligacion());

                info("La Obligaci\363n de PFO se elimin\363 exitosamente.");
