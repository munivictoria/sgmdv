...
public class CommunicationExcepcionesBean extends AbstractSessionBean {
	...
	private static final long serialVersionUID = -7854391348870524696L;
	...
	/**
	 * <p>
	 * Se llama a este metodo cuando la sesion que lo contiene esta apunto de configurarse en modo pasivo. Normalmente, esto ocurre en un contenedor de servlet
	 * distribuido cuando la sesion esta apunto de transferirse a otra instancia de contenedor, despues de la cual se llamara al metodo <code>activate()</code>
	 ...
	 */
	private List listaRefinanciaciones = null;
	 ...
	 * 
	 * @param listaRefinanciaciones
	 *            Nuevo valor de la propiedad listaRefinanciaciones.
	 */
	 ...
	 * Setter para propiedad listaRefinanciaciones.
	 * 
	 * @param listaPeriodosAdeudadosAuditoria
	 *            Nuevo valor de la propiedad listaPeriodosAdeudadosAuditoria.
	 */
	 ...
	 * 
	 * @param listaObligacionesRefinanciacion
	 *            Nuevo valor de la propiedad listaObligacionesRefinanciacion.
	 */
	 ...
	 * 
	 * @param listaPeriodosAdeudadosRefinanciacion
	 *            Nuevo valor de la propiedad listaPeriodosAdeudadosRefinanciacion.
	 */
	 ...
	 * 
	 * @param listaCuotasRefinanciacion
	 *            Nuevo valor de la propiedad listaCuotasRefinanciacion.
	 */
