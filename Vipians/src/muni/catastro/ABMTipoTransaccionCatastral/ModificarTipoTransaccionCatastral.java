 ...
 */
public class ModificarTipoTransaccionCatastral extends AbstractPageBean {
...
// </editor-fold>
     ...
     */
    public ModificarTipoTransaccionCatastral() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("ModificarTipoTransaccionCatastral Initialization Failure", e);
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            //    tipoTransaccionCatastral.setActivo(true);
              ...
              //  this.getComunicationCatastroBean().getRemoteSystemRegistroPropiedad().updateTipoTransaccionCatastral(tipoTransaccionCatastral);
                info("El Tipo de Transacci\363n Catastral se modific\363 exitosamente.");
            } catch (Exception ex) {
                // CAMBIAR: Cambiar los mensajes.
                log("ModificarTipoTransaccionCatastral_GuardarError:", ex);
                error("Modificar Tipo Transacci\363n Catastral - Guardar: " + ex.getMessage());
            }
