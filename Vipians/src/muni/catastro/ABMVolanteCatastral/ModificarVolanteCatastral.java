/*
 * ModificarVolanteCatastral.java
 *
 ...
 */
public class ModificarVolanteCatastral extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Modificar Volante Catastral";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ModificarVolanteCatastral";
...
//        else this.getTfParcela().setText("");
     ...
     */
    public ModificarVolanteCatastral() {
    }
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                int pos = 0;
                noVacios[pos] = this.getTfNroVolanteCatastral();
                nomNoVacios[pos++] = "N\272 de Volante Catastral";
                noVacios[pos] = this.getTfParcela();
                nomNoVacios[pos++] = "N\272 de Parcela";
                noVacios[pos] = this.getTfAvaluoTerreno();
                nomNoVacios[pos++] = "Avaluo del Terreno";
                noVacios[pos] = this.getTfAvaluoMejora();
                nomNoVacios[pos++] = "Avaluo de Mejora";
                ...
                this.getComunicationCatastroBean().getRemoteSystemInformacionParcelaria().updateVolanteCatastral(volanteCatastral);
                
                info("El Volante Catastral se modific\363 exitosamente.");
            } catch (Exception ex) {
