 ...
 * @author marcosdy
 */
public class ImprimirVolanteCatastral extends AbstractPageBean {

    private String idVolanteCatastral;

    public String getIdVolanteCatastral() {
        this.cargarDatos();        
        return idVolanteCatastral;
    }

    public void setIdVolanteCatastral(String idVolanteCatastral) {
    ...
    public void cargarDatos() {
        ...
        VolanteCatastral volanteCatastral = (VolanteCatastral) this.getSessionBean1().getObjetoImpresion();
        if (volanteCatastral != null){
            this.idVolanteCatastral = Long.toString(volanteCatastral.getIdVolanteCatastral());
        }
