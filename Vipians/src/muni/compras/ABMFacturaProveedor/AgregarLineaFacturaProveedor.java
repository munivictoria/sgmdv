 ...
 */
public class AgregarLineaFacturaProveedor extends AbstractPageBean {
    /**
...
//    private TipoCalle tipoCalleSeleccionado = null;
    ...
    private final String NOMBRE_PAGINA = "Agregar Linea de Factura de Proveedor";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AgregarLineaFacturaProveedor";
     ...
     */
    public AgregarLineaFacturaProveedor() {
    }
...
// Juan Pablo
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        ...
        ep.getObjetos().add(ind++, new LineaFacturaBien()); //4
        ep.getObjetos().add(ind++, new String()); //5 monto unitario
    ...
    private void guardarEstadoObjetosUsados() { //ver como seria realmente
        ...
        LineaFacturaBien lineaFactura = (LineaFacturaBien) this.obtenerObjetoDelElementoPila(4, LineaFacturaBien.class);
...
//            double locTotal = lineaFactura.getCantidad().doubleValue() * lineaFactura.getMontoUnitario().doubleValue();
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        LineaFacturaBien lineaFactura = new LineaFacturaBien(); //(LineaFactura) this.obtenerObjetoDelElementoPila(4, LineaFactura.class);
        ...
        if (this.getRequestBean1().getObjetoSeleccion() != null) {
            ...
            if (seleccionado instanceof Bien) {
                if (seleccionado != null) {
                    ...
                    //this.getTfMonto().setText(Conversor.getStringDeDouble(new Double(bien.getPrecio())));                    
                    this.getElementoPila().getObjetos().set(1, bien);
//                    this.getElementoPila().getObjetos().set(4, lineaFactura);
                    this.getElementoPila().getObjetos().set(5, montoUnitario);
                }
            ...
            if (seleccionado instanceof LineaFacturaBien) {
                if (seleccionado != null) {
                    lineaFactura = (LineaFacturaBien) seleccionado;
                    this.getElementoPila().getObjetos().set(4, lineaFactura);
                }
            }
        }
        ...
        lineaFactura = (LineaFacturaBien) this.obtenerObjetoDelElementoPila(4, LineaFacturaBien.class);
        montoUnitario = (String) this.obtenerObjetoDelElementoPila(5, String.class);
        
        System.out.println("Bien para mostrar: "+bien.getIdBien());
        ...
        if (cuentaRfr != null && cuentaRfr.getIdCuenta() != -1) {
            this.getTfCuenta().setText(cuentaRfr.toString());
        } else {
            this.getTfCuenta().setText(null);
        }

//        if (lineaFactura.getCantidad() != null) {
//            this.getTfCantidad().setText(lineaFactura.getCantidad().toString());
//        } else {
//            this.getTfCantidad().setText("0.0");
//        }

        if (montoUnitario != null && montoUnitario != "" && !montoUnitario.isEmpty()) {
            this.getTfMonto().setText(montoUnitario);
        } else {
            this.getTfMonto().setText(monto.toString());
        }
    }

    private void limpiarObjetosUsados() {
        // CAMBIAR: Crear una instancia por cada objeto manejado en la pagina
        LineaFacturaBien lineaFactura = new LineaFacturaBien();
        Bien bien = null;
...
//        this.getElementoPila().getObjetos().set(4, lineaFactura);
    ...
    private void setListaDelCommunication(ArrayList lista) {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        this.getComunicationCatastroBean().setListaCalles(lista);
    }
    ...
    private TableSelectPhaseListener getTableSelectPhaseListener() {
        ...
        return this.getComunicationCatastroBean().getTablePhaseListenerCalle();
    }
    // </editor-fold>
...
// </editor-fold>
    ...
    public String btnLimpiarTipoCalle_action() {
        ...
        if (ultimo) {
            this.limpiarObjeto(1, this.getTfBien());
...
//        return retorno;
    ...
    public void btnAgregarLinea_action() {
        ...
        pos = 0;
        flotantes[pos] = this.getTfCantidad();
        ...
        /*   if(this.getTfBien().getText().equals("") || this.getTfBien().getText().toString() == ""){
        String msg = "Debe seleccionar un Bien por el Proveedor";
        v.getErrores().add(msg);
        }*/
//        if (this.getTfCantidad().getText() != null && this.getTfCantidad().getText().toString().equals("0.0") || this.getTfCantidad().getText().toString().equals("0")){
//            String msg = "No se puede agregar una L\355nea de Factura Proveedor con Cantidad 0.";
//            v.getErrores().add(msg);
//        }
        if (this.getTfMonto().getText().toString().equals("0.0") || this.getTfMonto().getText().toString().equals("0")) {
    ...
    public String btnAceptar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getCommunicationComprasBean().setProveedorSeleccionado(proveedor);
