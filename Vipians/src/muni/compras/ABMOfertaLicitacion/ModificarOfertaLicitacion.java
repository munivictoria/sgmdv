 ...
 */
public class ModificarOfertaLicitacion extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Modificar Oferta Licitacion";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ModificarOfertaLicitacion";
     ...
     */
    public ModificarOfertaLicitacion() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("ModificarOfertaLicitacion Initialization Failure", e);
...
//        }
        ...
        //ofertaLicitacion.getActaApertura().setLicitacion(contratacion);
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        listaOfertaRenglonLicitacion = new ArrayList();
    ...
    public String btnAgregar_action() {
        ...
        if (ultimo) {
            ...
            if (contratacion.getIdContratacion() != -1) {
                ...
                listaRenglonesLicitacion.addAll(contratacion.getListaLineasContratacion());              
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                for (Iterator it = listaOfertaRenglonLicitacion.iterator(); it.hasNext();) {
                    LineaOfertaContratacion locRenglonOferta = (LineaOfertaContratacion) it.next();
                    if (locRenglonOferta.getIdLineaOfertaContratacion() < 0) {
                        locRenglonOferta.setIdLineaOfertaContratacion(-1);
                    }
                }
                ofertaLicitacion.setListaLineasOfertasContratacion(listaOfertaRenglonLicitacion);
                ///////////////////////////////////////////////////////////////
                ...
                ofertaLicitacion = this.getCommunicationComprasBean().getRemoteSystemAdministracionLicitacion().updateOfertaLicitacion(ofertaLicitacion);

                this.getRequestBean1().setRespuestaABM(ofertaLicitacion);

                this.setListaDelCommunication(null);

                info("La Oferta de Licitaci\363n se modific\363 exitosamente.");
