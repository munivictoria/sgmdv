/*
 * ConsultarOfertaLicitacion.java
 *
 ...
 */
public class ConsultarOfertaLicitacion extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Consultar Oferta Licitacion";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ConsultarOfertaLicitacion";
     ...
     */
    public ConsultarOfertaLicitacion() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("ConsultarOfertaLicitacion Initialization Failure", e);
...
//        this.getTfImporte().setText(Conversor.getStringDeDouble(ofertaLicitacion.getImporte()));
        ...
        //this.getTfEstado().setText(ofertaLicitacion.getEstado());
