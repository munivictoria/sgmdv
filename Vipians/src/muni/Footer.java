 ...
 * Footer.java
 *
 * Created on 4 de septiembre de 2006, 14:29
 * Copyright Asus
 */
package muni;
...
public class Footer extends AbstractPageBean {
    ...
    private StaticText stRuta = new StaticText();

    public StaticText getStRuta() {
        return stRuta;
    }

    public void setStRuta(StaticText st) {
        this.stRuta = st;
    }
    ...
    public void prerender() {
        String ruta = this.getSessionBean1().getRutaOperacion();
        if (ruta != null) {
            this.getStRuta().setText(ruta);
        }
        else {
            this.getStRuta().setText("<b>Ruta de la operaci&oacute;n:&nbsp;</b>Ninguna operaci&oacute;n iniciada.");
        }
    }
