 ...
 * Header.java
 *
 * Created on 22 de agosto de 2006, 10:40
 * Copyright Asus
 */
package muni;
...
//import com.droplets.api.ImageComponent;
 ...
 */
public class Header extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        try{ 
//            ParametroImagen locPar = (ParametroImagen)this.getComunicationBean().getRemoteSystemParametro().getParametroPorCodigo("35");
            //locPar.rebuildFile("/home/analia/");
            
          //  Image imagen = (Image) locPar.getValor();
          //  this.getImage1().setUrl("/resources/imagenes/cabecera.png");
            
            
        //    this.setImage((byte[])locPar.getValor());
           // this.getImage1().setValue(locPar);
            //this.getImageIcon().setImage(imagen);
            
//            Toolkit toolkit = Toolkit.getDefaultToolkit();
//            URL url = getClass().getResource( "imagenPie.jpg" );
            
//            Image image = toolkit.getImage( url ); 
           // frame.add( new ImageComponent( image ) ); 
                      
            
       //     JOptionPane.showMessageDialog(null,"imagen nom: " + locPar.getNombre(),"imagen",JOptionPane.OK_OPTION,new ImageIcon(imagen));            
          //  this.getImage1().setUrl("imagenPie.jpg");
        } catch (Exception e) {
    ...
    public ImageComponent getImage2() {
        FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("arregloBytes",  this.getApplicationBean1().getMunicipalidad().getLogo());
        this.getApplicationBean1().getMunicipalidad().getLogo();
        return image2;
    }

    public void setImage2(ImageComponent image2) {
        this.image2 = image2;
    }
