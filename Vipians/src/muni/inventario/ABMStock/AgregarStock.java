 ...
 */
public class AgregarStock extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Agregar Stock";
    // NOMBRE del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AgregarStock";
    ...
    public void init() {
        ...
        try {
            ...
            log("AgregarStock Initialization Failure", e);
...
//        // Dejar siempre en la ultimo posicion del arreglo. Manejo de seleccionado.
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        }else{ this.getTfBien().setText(null);
        }
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                Stock locStock = (Stock) this.obtenerObjetoDelElementoPila(0, Stock.class);
                if(locStock.getPuntoDeReposicion() != null){
                    locStock.getPuntoDeReposicion().setStock(locStock);
                }

                this.getCommunicationComprasBean().getRemoteSystemStock().setLlave(this.getSessionBean1().getLlave());
                this.getRequestBean1().setRespuestaABM(this.getCommunicationComprasBean().getRemoteSystemStock().addStock(locStock));
                
                this.getRequestBean1().setRespuestaABM(locStock);
                
                info("El Stock se agreg\363 exitosamente.");
    ...
    public PuntoDeReposicion getPuntoDeReposicionSeleccionado(){
        return this.puntoDeReposicionSeleccionado;
    }
    public void setPuntoDeReposicionSeleccionado(PuntoDeReposicion pPuntoDeReposicionSeleccionado){
        if(this.puntoDeReposicionSeleccionado == null) this.puntoDeReposicionSeleccionado = new PuntoDeReposicion();
        this.puntoDeReposicionSeleccionado = pPuntoDeReposicionSeleccionado;
    }
    ...
    public void setBienSeleccionada(Bien pBienSeleccionado) {
    ...
    public void setDepositoSeleccionada(Deposito pDepositoSeleccionado) {
