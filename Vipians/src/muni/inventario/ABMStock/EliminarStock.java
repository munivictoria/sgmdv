 ...
 */
public class EliminarStock extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Eliminar Stock";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EliminarStocl";
    ...
    public void init() {
        ...
        try {
            ...
            log("EliminarDeposito Initialization Failure", e);
    ...
    public String btnEliminar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getCommunicationComprasBean().getRemoteSystemStock().deleteStock(locStock);

                this.getRequestBean1().setRespuestaABM(locStock);

                info("El Stock se elimin\363 exitosamente.");
