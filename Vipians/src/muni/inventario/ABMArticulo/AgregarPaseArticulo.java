 ...
 */
public class AgregarPaseArticulo extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Agregar Pase Articulo";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AgregarPaseArticulo";
    ...
    private TextField tfAreaDestino = new TextField();

    public TextField getTfAreaDestino() {
        return tfAreaDestino;
    }

    public void setTfAreaDestino(TextField tfAreaDestino) {
        this.tfAreaDestino = tfAreaDestino;
    }
    ...
    private Button btnEfectuarPase = new Button();

    public Button getBtnEfectuarPase() {
        return btnEfectuarPase;
    }

    public void setBtnEfectuarPase(Button btnEfectuarPase) {
        this.btnEfectuarPase = btnEfectuarPase;
    }
    ...
    private TextField tfFechaPase = new TextField();

    public TextField getTfFechaPase() {
        return tfFechaPase;
    }

    public void setTfFechaPase(TextField tfFechaPase) {
        this.tfFechaPase = tfFechaPase;
    }
    ...
    private ObjectListDataProvider ldpListaPasesArticulo = new ObjectListDataProvider();

    public ObjectListDataProvider getLdpListaPasesArticulo() {
        return ldpListaPasesArticulo;
    }

    public void setLdpListaPasesArticulo(ObjectListDataProvider ldpListaPasesArticulo) {
        this.ldpListaPasesArticulo = ldpListaPasesArticulo;
    }
    ...
    private StaticText stOrigen = new StaticText();

    public StaticText getStOrigen() {
        return stOrigen;
    }

    public void setStOrigen(StaticText stOrigen) {
        this.stOrigen = stOrigen;
    }
    private StaticText stDestino = new StaticText();

    public StaticText getStDestino() {
        return stDestino;
    }

    public void setStDestino(StaticText stDestino) {
    ...
    private ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
        ...
        //ep.getObjetos().add(ind++, new Area()); //Area de Origen
        //ep.getObjetos().add(ind++, new InformacionTecnica());
        ep.getObjetos().add(ind++, new ArrayList()); //Lista de paseslistaPases
        ep.getObjetos().add(ind++, new PaseArticulo());
        ep.getObjetos().add(ind++, new Area()); //Area Destino
        ep.getObjetos().add(ind++, new Area()); //Area Origen
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        ArrayList listaPases = (ArrayList) this.obtenerObjetoDelElementoPila(ind++, ArrayList.class);
        PaseArticulo paseArticulo = (PaseArticulo) this.obtenerObjetoDelElementoPila(ind++, PaseArticulo.class);
        Area areaDestino = (Area) this.obtenerObjetoDelElementoPila(ind++, Area.class);
        Area areaOrigen = (Area) this.obtenerObjetoDelElementoPila(ind++, Area.class);

        Object fechaPase = this.getTfFechaPase().getText();
        Object comentarios = this.getTaComentarios().getText();

        if (areaDestino.getIdArea() == -1) {
            areaDestino = null;
        }
        paseArticulo.setAreaDestino(areaDestino);

        if (fechaPase != null && fechaPase != "") {
        paseArticulo.setFecha(Conversor.getFechaCortaDeString(fechaPase.toString()));
        } else {
        paseArticulo.setFecha(null);
        }
        
        if (comentarios != null && comentarios != "") {
            paseArticulo.setComentario(comentarios.toString());
        } else {
            paseArticulo.setComentario(null);
        }
        ...
        this.getElementoPila().getObjetos().set(ind++, listaPases);
        this.getElementoPila().getObjetos().set(ind++, paseArticulo);
        this.getElementoPila().getObjetos().set(ind++, areaDestino);
        this.getElementoPila().getObjetos().set(ind++, areaOrigen);
    }
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        PaseArticulo paseArticulo = null;
        Area areaDestino = null;
        Area areaOrigen = null;
        List listaPases = new ArrayList();

        if (this.getRequestBean1().getObjetoABM() != null) {
            articulo = (Articulo) this.getRequestBean1().getObjetoABM();
            areaOrigen = (Area) articulo.getArea();
            //informacionTecnica = (InformacionTecnica) articulo.getInformacionTecnica();

            if (articulo.getListaPaseArticulo() != null && articulo.getListaPaseArticulo().size() > 0) {
                listaPases = new ArrayList (articulo.getListaPaseArticulo()) ;
            }
            ...
            //this.getElementoPila().getObjetos().set(ind++, informacionTecnica);
            this.getElementoPila().getObjetos().set(ind++, listaPases);
            this.getElementoPila().getObjetos().set(4, areaOrigen);
        }
        ...
        if (this.getRequestBean1().getObjetoSeleccion() != null) {
            ...
            if (seleccionado instanceof Area) {
                areaDestino = (Area) seleccionado;
                this.getElementoPila().getObjetos().set(3, areaDestino);
            }
        }
        ...
        listaPases = (ArrayList) this.obtenerObjetoDelElementoPila(ind++, ArrayList.class);
        paseArticulo = (PaseArticulo) this.obtenerObjetoDelElementoPila(ind++, PaseArticulo.class);
        areaDestino = (Area) this.obtenerObjetoDelElementoPila(ind++, Area.class);
        areaOrigen = (Area) this.obtenerObjetoDelElementoPila(ind++, Area.class);
        ...
        this.getTfArea().setText(articulo.getArea());

        if (articulo.getInformacionTecnica() != null) {
        InformacionTecnica informacionTecnica = articulo.getInformacionTecnica();
        ...
        if (areaDestino != null && areaDestino.getIdArea() != -1) {
            this.getTfAreaDestino().setText(areaDestino);
        }
        this.getTfFechaPase().setText(Conversor.getStringDeFechaCorta(paseArticulo.getFecha()));
        this.getTaComentarios().setText(paseArticulo.getComentario());

        this.getObjectListDataProvider().setList(listaPases);
        this.setListaDelCommunication((ArrayList)listaPases);
    ...
    private ObjectListDataProvider getObjectListDataProvider() {
        ...
        return this.getLdpListaPasesArticulo();
    ...
    // </editor-fold>
    public void setCurrentRow(String row) {
        this.getTableRowGroup1().getRowKey().setRowId(row);
    }
    ...
    public String btnLimpiarArea_action() {
        ...
        if (ultimo) {
            ...
            this.limpiarObjeto(3, Area.class, this.getTfAreaDestino());
            this.guardarEstadoObjetosUsados();
        } else {
            retorno = this.prepararCaducidad();
        }
    ...
    public String btnEfectuarPase_action() {
        String retorno = null;
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
        ...
        if (ultimo) {
            ...
            try {
                ...
                int pos = 0;
                noVacios[pos] = this.getTfAreaDestino();
                nomNoVacios[pos++] = "Area Destino";
                noVacios[pos] = this.getTfFechaPase();
                nomNoVacios[pos++] = "Fecha de Pase";
                noVacios[pos] = this.getTaComentarios();
                nomNoVacios[pos++] = "Comentarios";
                
                pos = 0;
                fechas[pos] = this.getTfFechaPase();
                ...
                if (areaDestino.equals(areaOrigen)) {
                    warn("El art\355culo ya se encuentra en ese \341rea");
                    return null;
                }
                
                paseArticulo.setAreaOrigen(areaOrigen);
                paseArticulo.setUsuario(this.getSessionBean1().getUsuario());
               
                articulo.setArea(areaDestino);
                paseArticulo.setArticulo(articulo);
            
                listaPases.add(paseArticulo);
                articulo.setListaPaseArticulo(listaPases);
                ...
                articulo = this.getCommunicationComprasBean().getRemoteSystemStock().updateArticulo(articulo);                
                articulo = this.getCommunicationComprasBean().getRemoteSystemStock().getArticuloPorId(articulo.getIdArticulo());
                
                this.getRequestBean1().setObjetoABM(articulo);                
                this.mostrarEstadoObjetosUsados();
         
                info("El Pase de Area se ha efectuado de manera exitosa.");

                this.limpiarObjeto(3, Area.class, this.getTfAreaDestino());
                this.getTfFechaPase().setText(null);
                this.getTaComentarios().setText(null);;


            } catch (Exception ex) {
                log(CASO_NAVEGACION + "_PaseArticuloError:", ex);
                error(NOMBRE_PAGINA + " - Pase de Area de Articulo: " + ex.getMessage());
            }
    ...
    private ArrayList getListaDelCommunication() {
        ...
        return this.getCommunicationComprasBean().getListaPasesArticulo();
    }

    private void setListaDelCommunication(ArrayList lista) {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        this.getCommunicationComprasBean().setListaPasesArticulo(lista);
    }
