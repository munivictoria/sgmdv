 ...
 */
public class ModificarArticulo extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Modificar Articulo";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ModificarArticulo";
    ...
    public void init() {
        ...
        try {
            ...
            log("ModificarArticulo Initialization Failure", e);
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                int pos = 0;
                noVacios[pos] = this.getTfCodigoArticulo();
                nomNoVacios[pos++] = "C\363digo Art\355culo";
                noVacios[pos] = this.getTfFechaEntradaServicio();
                nomNoVacios[pos++] = "Fecha Entrada Servicio";
                noVacios[pos] = this.getTfCosto();
                ...
                pos = 0;
                fechas[pos] = this.getTfFechaEntradaServicio();
                nomFechas[pos++] = "Fecha Entrada Servicio";

                pos = 0;
                flotantes[pos] = this.getTfCosto();
                nomFlotantes[pos++] = "Costo";

                pos = 0;
                esPositivo[pos] = this.getTfCosto();
                ...
                this.getRequestBean1().setRespuestaABM(articulo);

                info("El Art\355culo se modific\363 exitosamente.");
