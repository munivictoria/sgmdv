...
// */
//public class ModificarExencionRegistroDeuda extends AbstractPageBean {
...
//        }
//    }
//    private ObjectListDataProvider ldpRegistroDeuda = new ObjectListDataProvider();
//
//    public ObjectListDataProvider getLdpRegistroDeuda() {
//        return ldpRegistroDeuda;
//    }
//
//    public void setLdpRegistroDeuda(ObjectListDataProvider oldp) {
//        this.ldpRegistroDeuda = oldp;
//    }
...
//    private final String NOMBRE_PAGINA = "Modificar Exencion";
//    // nombre del caso de navegacion para llegar a esta pagina.
//    private final String CASO_NAVEGACION = "ModificarExencionRegistroDeuda";
...
//     */
//    public ModificarExencionRegistroDeuda() {
//    }
//
//    /**
...
//            _init();
//        } catch (Exception e) {
//            log("ModificarExencion Initialization Failure", e);
...
//        ep.getObjetos().add(ind++, new ExencionRegistroDeuda()); //copia
...
//        ep.getObjetos().add(ind++, null); //periodicidad cuota
//        ep.getObjetos().add(ind++, null); //arraylist
//
//
//
...
//        ExencionRegistroDeuda locExencionRegistroDeudaCopy = (ExencionRegistroDeuda) this.obtenerObjetoDelElementoPila(ind++, ExencionRegistroDeuda.class);
...
//            locExencionRegistroDeuda.setPorcentaje(new Double(porcentaje.toString()));
//        } else {
//            locExencionRegistroDeuda.setPorcentaje(null);
//        }
//        if (motivo != null && motivo != "") {
//            locExencionRegistroDeuda.setMotivo(motivo.toString());
//        } else {
//            locExencionRegistroDeuda.setMotivo(null);
//        }
//
...
//
//        System.out.println("GE period cuotassssss:" +  locExencionRegistroDeuda.getPeriodicidadCuotas());
//
...
//        
////        Comentado
////        locExencionRegistroDeuda.setPeriodo(periodo);
...
//        }
//     
//        locExencionRegistroDeuda.setDigestoMunicipal(digestoMunicipal);
...
//        this.getElementoPila().getObjetos().set(ind++, locExencionRegistroDeudaCopy);
...
//        ExencionRegistroDeuda locExencionRegistroDeudaCopy = null;
...
//        ArrayList listaRegistrosDeudaOriginal= null;
...
//                this.getElementoPila().getObjetos().set(3, digesto);
//        
...
//                this.getElementoPila().getObjetos().set(2, locRegistroExencion);
//            }
...
//                listaRegistrosDeudaOriginal = new ArrayList();
//                listaRegistrosDeudaOriginal.addAll(locExencionRegistroDeuda.getListaRegistrosExencion());
//                locExencionRegistroDeudaCopy =  ExencionRegistroDeuda.copy(locExencionRegistroDeuda);
//            } catch (Exception e) {
...
//            periodicidadCuota = locExencionRegistroDeuda.getPeriodicidadCuotas();
//
//            this.getElementoPila().getObjetos().set(0, locExencionRegistroDeuda);
//            this.getElementoPila().getObjetos().set(1, locExencionRegistroDeudaCopy);//guardo copia
//            this.getElementoPila().getObjetos().set(3, digesto);
//            this.getElementoPila().getObjetos().set(4, anio);
//            this.getElementoPila().getObjetos().set(5, periodicidad);
//            this.getElementoPila().getObjetos().set(6, periodoNumero);
//            this.getElementoPila().getObjetos().set(7, periodicidadCuota);
//            this.getElementoPila().getObjetos().set(8, listaRegistrosDeudaOriginal);
//
//        }
//
//        int ind = 0;
...
//        locExencionRegistroDeudaCopy= (ExencionRegistroDeuda) this.obtenerObjetoDelElementoPila(ind++, ExencionRegistroDeuda.class);
...
//
//        if (locExencionRegistroDeuda.getEstado().equals(Estado.VIGENTE)) {
//            this.cambiarEstadoComponentes(true);
//        }
//
//        if ((locExencionRegistroDeuda.getEstado().equals(Estado.CREADA)) && (locExencionRegistroDeuda.getListaRegistrosExencion().size() > 0)) {
//            this.cambiarEstadoComponentes(true);
//        }
//
...
//        listaExenciones.addAll(locExencionRegistroDeuda.getListaRegistrosExencion());
//
//        RegistroExencionRegistroDeuda locRegDeuda = new RegistroExencionRegistroDeuda();
//        Iterator iter = locExencionRegistroDeuda.getListaRegistrosExencion().iterator();
//
//        while (iter.hasNext()) {
//            locRegDeuda = (RegistroExencionRegistroDeuda) iter.next();
//           
//        }
//
//        this.getObjectListDataProvider().setList(listaExenciones);
...
//        return this.getLdpRegistroDeuda();
//    }
//
...
//                noVacios[pos] = this.getTfAnio();
//                nomNoVacios[pos++] = "A\361o";
//                noVacios[pos] = this.getDdPeriodicidad();
//                nomNoVacios[pos++] = "Periodicidad";
//                noVacios[pos] = this.getTfPeriodo();
//                nomNoVacios[pos++] = "N\372mero de Periodo";
...
//                this.getCommunicationSAICBean().getRemoteSystemExencion().updateExencionRegistroDeuda(locExencionRegistroDeuda);
//
//                this.getRequestBean1().setRespuestaABM(locExencionRegistroDeuda);
//
//                info("La Exenci\363n se modific\363 exitosamente.");
//            } catch (Exception ex) {
...
//        try {
//            boolean ultimo = this.ultimoElementoPilaDeSubSesion();
//            ExencionRegistroDeuda locExencionRegistroDeudaCopy = (ExencionRegistroDeuda) this.obtenerObjetoDelElementoPila(1, ExencionRegistroDeuda.class);
//            System.out.println("exencionCopy en cancelar, period cuota: " + locExencionRegistroDeudaCopy.getPeriodicidadCuotas());
//            if (ultimo) {
//                try {
//                    this.getCommunicationSAICBean().getRemoteSystemExencion().setLlave(this.getSessionBean1().getLlave());
//                    this.getCommunicationSAICBean().getRemoteSystemExencion().updateExencionRegistroDeuda(locExencionRegistroDeudaCopy);
//                } catch (Exception ex) {
//                    ex.printStackTrace();
//                }
...
//
//        this.tfPorcentaje.setDisabled(deshabilitar);
//        this.btnLimpiarDigesto.setDisabled(deshabilitar);
//        this.btnSeleccionarDigesto.setDisabled(deshabilitar);
//        this.ddPeriodicidad.setDisabled(deshabilitar);
//        this.tfAnio.setDisabled(deshabilitar);
//        this.tfPeriodo.setDisabled(deshabilitar);
//    }
//
...
//    }
//
//    public String btnSeleccionarLiquidacionOSP_action() {
//        String retorno = null;
//        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
//
//        if (ultimo) {
...
//            Object periodoTexto = this.tfPeriodo.getText();
//
//            if (anioTexto == null || periodicidadSelected == null || periodoTexto == null) {
...
//    }
//
//    public String btnSeleccionarLiquidacionTGI_action() {
//        String retorno = null;
//        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
//
//        if (ultimo) {
...
//    }
//
//    public String btnSeleccionarLiquidacionPFO_action() {
//        String retorno = null;
//        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
//
//        if (ultimo) {
...
//    }
//
//    public String btnSeleccionarLiquidacionSHPS_action() {
//        String retorno = null;
//        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
//
//        if (ultimo) {
...
//    }
//
//    public String btnSeleccionarReliquidacion_action() {
//        String retorno = null;
//        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
//
//        if (ultimo) {
...
//                    RegistroExencionRegistroDeuda locRegistroExencion =  (RegistroExencionRegistroDeuda) obj;
//                    locExencionRegistroDeuda.removeRegistroDeudaExento(locRegistroExencion);
//
//                    if (locRegistroExencion.getIdRegistroExencionRegistroDeuda() != -1){
//                        try {
//                            this.getCommunicationSAICBean().getRemoteSystemExencion().setLlave(this.getSessionBean1().getLlave());
//                            locExencionRegistroDeuda = this.getCommunicationSAICBean().getRemoteSystemExencion().updateExencionRegistroDeuda(locExencionRegistroDeuda);
//                        } catch (Exception ex) {
//                            ex.printStackTrace();
//                        }
//
//                        if (locExencionRegistroDeuda.getEstado().equals(ExencionRegistroDeuda.Estado.CREADA) && locExencionRegistroDeuda.getListaRegistrosExencion().size() > 0) {
//                                this.cambiarEstadoComponentes(true);
//                        } else {
...
//                    }
//                    else{
//                        locExencionRegistroDeuda.getListaRegistrosExencion().remove(locRegistroExencion);
//                    }
//                    this.getElementoPila().getObjetos().set(0, locExencionRegistroDeuda);
//                    this.refrescarTabla();
//                }
