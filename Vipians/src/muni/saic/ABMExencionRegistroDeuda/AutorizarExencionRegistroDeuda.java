 ...
 */
public class AutorizarExencionRegistroDeuda extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Autorizar Exencion";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AutorizarExencionRegistroDeuda";
     ...
     */
    public AutorizarExencionRegistroDeuda() {
    }
    ...
    public void init() {
        ...
        // TODO - Autorizar código de inicio propio aquí

        // <editor-fold defaultstate="collapsed" desc="Inicio de componente administrado por el programa">
        // Iniciar componentes administrados automáticamente
        // *Nota* - esta lógica NO debe Autorizarse
        try {
            _init();
        } catch (Exception e) {
            log("AutorizarExencion Initialization Failure", e);
...
//            periodoNumero = locExencionRegistroDeuda.getPeriodo().getNumeroPeriodo();
     ...
     //periodo:
       ...
       listaFirmas.addAll(locExencionRegistroDeuda.getListaFirmas());
    ...
    public String btnAutorizar_action() throws RemoteException {
        ...
        if (ultimo) {
            try {
                ...
                this.getCommunicationSAICBean().getRemoteSystemExencion().autorizarExencionRegistroDeuda((ExencionRegistroDeuda) locExencionRegistroDeuda);
