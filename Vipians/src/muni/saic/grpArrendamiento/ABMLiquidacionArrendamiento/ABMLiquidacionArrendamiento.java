/*
 * ABMLiquidacionArrendamiento.java
 *
 ...
 * 
 */
public class ABMLiquidacionArrendamiento extends ABMPageBean {
	 ...
	 * </p>
	 */
	public ABMLiquidacionArrendamiento() {
	}

	protected ElementoPila agregarObjetosAElementoPila(ElementoPila ep) {
		int ind = 0;
		ep.getObjetos().add(ind++, null); // Liquidacion Arrendamiento
	...
	protected void mostrarEstadoObjetosUsados() {
		LiquidacionTasa liquidacionArrendamiento = (LiquidacionTasa) this.obtenerObjetoDelElementoPila(0);

		if(liquidacionArrendamiento != null) {
			this.getTfPeriodo().setText(liquidacionArrendamiento.getPeriodoAnio().toString());
			this.getTaFormula().setText(liquidacionArrendamiento.getStringFormula());
			this.getTaParametros().setText(liquidacionArrendamiento.getStringParametrosValuados());
			this.getTaModificadores().setText(liquidacionArrendamiento.getStringModificadoresLiquidacion());
			this.getTaVencimientos().setText(liquidacionArrendamiento.getStringVencimientos());
			if(liquidacionArrendamiento.getRegistroExencionRegistroDeuda() != null) {
				this.getTaExencion().setText(liquidacionArrendamiento.getRegistroExencionRegistroDeuda().getExencionRegistroDeuda().toString());
			}

			this.getTfFechaObligacion().setText(liquidacionArrendamiento.getFechaEmision());
			this.getTaObligacion().setText(liquidacionArrendamiento.getStringObligacion());
			this.getTfCuotaLiquidada().setText(liquidacionArrendamiento.getCuotaLiquidada());
			this.getTfEstado().setText(liquidacionArrendamiento.getEstado().toString());
			this.getTfMonto().setText(Conversor.getStringDeDouble(liquidacionArrendamiento.getMonto()));
			if(liquidacionArrendamiento.getFechaCancelacion() != null) {
				this.getTfFechaCancelacion().setText(liquidacionArrendamiento.getFechaCancelacion());
			}
		}
	}
	...
	protected void procesarObjetoABM(Object pObject) {
		LiquidacionTasa liquidacionArrendamiento = (LiquidacionTasa) pObject;
		try {
			this.getCommunicationSAICBean().getRemoteSystemLiquidacionTasa().setLlave(this.getSessionBean1().getLlave());
			liquidacionArrendamiento = (LiquidacionTasa) this.getCommunicationSAICBean().getRemoteSystemLiquidacionTasa().getRegistroDeudaPorId(new Long(liquidacionArrendamiento.getIdRegistroDeuda()));
		} catch(Exception e) {
			e.printStackTrace();
		}

		this.getElementoPila().getObjetos().set(0, liquidacionArrendamiento);
	}
	...
	public String getNombreBean() {
		return "#{saic$grpArrendamiento$ABMLiquidacionArrendamiento$ABMLiquidacionArrendamiento}";
	}
