/*
 * EnJuicioAuditoriaTributaria.java
 *
 ...
 */
public class EnJuicioAuditoriaTributaria extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "EnJuicio Auditoria Tributaria";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EnJuicioAuditoriaTributaria";
     ...
     */
    public EnJuicioAuditoriaTributaria() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("EnJuicioAuditoriaTributaria Initialization Failure", e);
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        if (this.getRequestBean1().getObjetoSeleccion() != null) {
            ...
            if (seleccionado instanceof Intimacion) {
                ...
                System.out.println("tam lista intimac(instanceof)------:" + listaIntimaciones.size());
...
//                }
                ...
                this.getCommunicationSAICBean().getRemoteSystemAuditoriaTributaria().enjuiciarAuditoriaTributaria(auditoriaTributaria);

                this.getRequestBean1().setRespuestaABM(auditoriaTributaria);

                info("La Auditoria Tributaria se paso a Juicio exitosamente.");
