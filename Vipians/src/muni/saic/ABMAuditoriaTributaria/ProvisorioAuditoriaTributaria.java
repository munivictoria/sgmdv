/*
 * ProvisorioAuditoriaTributaria.java
 *
 ...
 */
public class ProvisorioAuditoriaTributaria extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Provisorio Auditoria Tributaria";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ProvisorioAuditoriaTributaria";
...
//        numberConverter1.setPattern("$ #,###,##0.000");
     ...
     */
    public ProvisorioAuditoriaTributaria() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("ProvisorioAuditoriaTributaria Initialization Failure", e);
...
//                }
                ...
                this.getCommunicationSAICBean().getRemoteSystemAuditoriaTributaria().previsionarAuditoriaTributaria(auditoriaTributaria);

                this.getRequestBean1().setRespuestaABM(auditoriaTributaria);

                info("La Auditoria Tributaria se paso a estado Provisorio exitosamente.");
