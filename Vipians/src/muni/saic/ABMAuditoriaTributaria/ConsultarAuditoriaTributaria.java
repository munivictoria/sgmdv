/*
 * ConsultarAuditoriaTributaria.java
 *
 ...
 */
public class ConsultarAuditoriaTributaria extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Consultar Auditoria Tributaria";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ConsultarAuditoriaTributaria";
...
//        numberConverter1.setPattern("$ #,###,##0.000");
    ...
    public void setLdpCuotasRefinanciacion(ObjectListDataProvider ldpCuotasRefinanciacion) {
        this.ldpCuotasRefinanciacion = ldpCuotasRefinanciacion;
    }
    private ObjectListDataProvider ldpLog = new ObjectListDataProvider();

    public ObjectListDataProvider getLdpLog() {
        return ldpLog;
    }

    public void setLdpLog(ObjectListDataProvider ldpLog) {
        this.ldpLog = ldpLog;
    }
    ...
    public void setStaticText28(StaticText staticText28) {
        this.staticText28 = staticText28;
    }
     ...
     */
    public ConsultarAuditoriaTributaria() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("ConsultarAuditoriaTributaria Initialization Failure", e);
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        if (selectedRowKeys.length > 0) {
            for (int i = 0; i < selectedRowKeys.length; i++) {
                ...
                auditoriaTributaria.addRegistroDeuda(locRegistroDeuda);
                //listaPeriodosAdeudadosSeleccionados.add(locRegistroDeuda);
            }
        }
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        listLog.addAll(auditoriaTributaria.getListaLogCambios());
        this.setListaDelCommunicationTabla4(listLog);
        this.getObjectListDataProviderTabla4().setList(listLog);

        if (auditoriaTributaria.getDocumentoRefinanciacion() != null) {
            if (auditoriaTributaria.getDocumentoRefinanciacion().getListaRegistrosDeuda() != null && auditoriaTributaria.getDocumentoRefinanciacion().getListaRegistrosDeuda().size() > 0) {
                ArrayList listCuotasRef = new ArrayList();
                listCuotasRef.addAll(auditoriaTributaria.getDocumentoRefinanciacion().getListaRegistrosDeuda());
                this.setListaDelCommunicationTabla5(listCuotasRef);
                this.getObjectListDataProviderTabla5().setList(listCuotasRef);
            }
        }
    ...
    private ObjectListDataProvider getObjectListDataProviderTabla4() {
        // CAMBIAR: Utilizar el ObjectListDataProvider correspondiente
        return this.getLdpLog();
    }

    private ArrayList getListaDelCommunicationTabla4() {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        return this.getCommunicationSAICBean().getListaLogAuditoriaTributaria();
    }

    private void setListaDelCommunicationTabla4(ArrayList lista) {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        this.getCommunicationSAICBean().setListaLogAuditoriaTributaria(lista);
    }
    ...
    private ArrayList getListaDelCommunicationTabla5() {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        return this.getCommunicationSAICBean().getListaCuotasRefinanciacion();
    }

    private void setListaDelCommunicationTabla5(ArrayList lista) {
        // CAMBIAR: Utilizar la Lista del Comunication que corresponda
        this.getCommunicationSAICBean().setListaCuotasRefinanciacion(lista);
    }
...
//                }
                ...
                this.getCommunicationSAICBean().getRemoteSystemAuditoriaTributaria().deleteAuditoriaTributaria(auditoriaTributaria);

                //   this.getRequestBean1().setRespuestaABM(auditoriaTributaria);

                info("La Auditoria Tributaria se elimin\363 exitosamente.");
