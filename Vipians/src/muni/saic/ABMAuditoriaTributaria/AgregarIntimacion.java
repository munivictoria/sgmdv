 ...
 */
public class AgregarIntimacion extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Agregar Intimacion";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AgregarIntimacion";
    ...
    public void init() {
        ...
        try {
            ...
            log("AgregarIntimacion Initialization Failure", e);
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                info("La Intimaci\363n se agreg\363 exitosamente.");
