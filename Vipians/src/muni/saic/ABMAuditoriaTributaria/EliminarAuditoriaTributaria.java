/*
 * EliminarAuditoriaTributaria.java
 *
 ...
 */
public class EliminarAuditoriaTributaria extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Eliminar Auditoria Tributaria";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EliminarAuditoriaTributaria";
...
//        numberConverter1.setPattern("$ #,###,##0.000");
     ...
     */
    public EliminarAuditoriaTributaria() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("EliminarAuditoriaTributaria Initialization Failure", e);
