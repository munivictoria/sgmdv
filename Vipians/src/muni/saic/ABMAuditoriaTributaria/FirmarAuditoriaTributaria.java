/*
 * FirmarAuditoriaTributaria.java
 *
 ...
 */
public class FirmarAuditoriaTributaria extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Firmar Auditoria Tributaria";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "FirmarAuditoriaTributaria";
     ...
     */
    public FirmarAuditoriaTributaria() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("FirmarAuditoriaTributaria Initialization Failure", e);
...
//                }
                ...
                this.getCommunicationSAICBean().getRemoteSystemAuditoriaTributaria().firmarAuditoriaTributaria(this.getSessionBean1().getUsuario(), auditoriaTributaria);

                //   this.getRequestBean1().setRespuestaABM(auditoriaTributaria);

                info("La Auditoria Tributaria se Firm\363 exitosamente.");
