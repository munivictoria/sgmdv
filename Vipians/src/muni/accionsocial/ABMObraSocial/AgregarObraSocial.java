 ...
 */
public class AgregarObraSocial extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Agregar Obra Social";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AgregarObraSocial";
    ...
    public void init() {
        ...
        try {
            ...
            log("AgregarObraSocial Initialization Failure", e);
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getComunicationAccionSocialBean().getRemoteSystemFichaSocial().addObraSocial(obraSocial);

                info("La Obra Social se agreg\363 exitosamente.");
