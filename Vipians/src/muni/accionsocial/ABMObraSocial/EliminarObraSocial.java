 ...
 */
public class EliminarObraSocial extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Eliminar Obra Social";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EliminarObraSocial";
    ...
    public void init() {
        ...
        try {
            ...
            log("EliminarObraSocial Initialization Failure", e);
...
//        ep.getObjetos().add(ind++, new TipoObraSocial());
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        if (nombre != null && nombre != "") obraSocial.setNombre(nombre.toString()); else obraSocial.setNombre(null);
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        if (this.getRequestBean1().getObjetoABM() != null) {
            obraSocial = (ObraSocial) this.getRequestBean1().getObjetoABM();
    ...
    public String btnEliminar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getComunicationAccionSocialBean().getRemoteSystemFichaSocial().deleteObraSocial(obraSocial);
                
                info("La Obra Social se elimin\363 exitosamente.");
