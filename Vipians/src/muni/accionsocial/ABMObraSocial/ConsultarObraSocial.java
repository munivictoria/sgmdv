 ...
 */
public class ConsultarObraSocial extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Consultar Obra Social";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ConsultarObraSocial";
    ...
    public void init() {
        ...
        try {
            ...
            log("ConsultarObraSocial Initialization Failure", e);
