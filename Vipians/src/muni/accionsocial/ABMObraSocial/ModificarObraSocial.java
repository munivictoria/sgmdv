...
//import com.trascender.accionSocial.recurso.persistent.TipoObraSocial;
 ...
 */
public class ModificarObraSocial extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Modificar Obra Social";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ModificarObraSocial";
    ...
    public void init() {
        ...
        try {
            ...
            log("ModificarObraSocial Initialization Failure", e);
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getComunicationAccionSocialBean().getRemoteSystemFichaSocial().updateObraSocial(obraSocial);

                info("La Obra Social se modific\363 exitosamente.");
