 ...
 */
public class EliminarFichaSocial extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Eliminar FichaSocial";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EliminarFichaSocial";
    ...
    public void init() {
        ...
        try {
            ...
            log("EliminarFichaSocial Initialization Failure", e);
...
////        TipoFichaSocial tipoFichaSocial = (TipoFichaSocial) this.obtenerObjetoDelElementoPila(1, TipoFichaSocial.class);
//
//        Object codigo = this.getTfCodigo().getText();
//        Object nombre = this.getTfNombre().getText();
//
////        if (codigo != null && codigo != "") fichaSocial.setCodigo(codigo.toString()); else fichaSocial.setCodigo(null);
////        if (nombre != null && nombre != "") fichaSocial.setNombre(nombre.toString()); else fichaSocial.setNombre(null);
//
    ...
    public String btnEliminar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getComunicationAccionSocialBean().getRemoteSystemFichaSocial().deleteFichaSocial(fichaSocial);
                info("La FichaSocial se elimin\363 exitosamente.");
