 ...
 */
public class AgregarFichaSocial extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Agregar FichaSocial";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AgregarFichaSocial";
    ...
    public void init() {
        ...
        try {
            ...
            log("AgregarFichaSocial Initialization Failure", e);
...
////            tipoFichaSocial = fichaSocial.getTipoFichaSocial();
//            
//            this.getElementoPila().getObjetos().set(0, fichaSocial);
////            this.getElementoPila().getObjetos().set(1, tipoFichaSocial);
//        }
        ...
        if (this.getRequestBean1().getObjetoSeleccion() != null) {
            ...
            if (seleccionado instanceof Beneficiario) {               
                ...
                if (this.getRequestBean1().getTipoSeleccion() != null) {
                    ...
                    } else if (this.getRequestBean1().getTipoSeleccion() == "FAMILIAR") {
        ...
        if (ultimo) {
            ...
            try {
                ...
                v.esNumero(esEntero, nomEsEntero);
                                ...
                                //PROBANDO
//                Tab tab = this.getTabSet1().findChildTab("three");
//                Object o = tab.getChildren().get(1);
//                System.out.println("a verrrr" + o);
//                System.out.println("a verrrr nombre " + ((TextField)o).getId());
//                
//                ((TextField)o).setValid(false);
//                System.out.println("es visible " + ((TextField)o).isVisible());
                
//                        setRendered(true);
//                this.getTfNroCasas().setValid(false);
                ...
                this.getComunicationAccionSocialBean().getRemoteSystemFichaSocial().addFichaSocial(fichaSocial);

                info("La Ficha Social se agreg\363 exitosamente.");
    ...
    public String btnSeleccionarTipoFichaSocial_action() {
        String retorno = null;
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
        ...
        if (ultimo) {
            ...
            try {
                ...
                if (rk != null) {
                    ...
                    fichaSocial.getGrupoFamiliar().remove((Beneficiario) obj);
                    this.getElementoPila().getObjetos().set(0, fichaSocial);
