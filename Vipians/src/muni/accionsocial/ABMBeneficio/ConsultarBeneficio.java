 ...
 */
public class ConsultarBeneficio extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Consultar Beneficio";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ConsultarBeneficio";
    ...
    public void init() {
        ...
        try {
            ...
            log("ConsultarBeneficio Initialization Failure", e);
...
//        ep.getObjetos().add(ind++, new TipoBeneficio());
