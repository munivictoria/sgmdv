 ...
 */
public class ModificarBeneficio extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Modificar Beneficio";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "ModificarBeneficio";
    ...
    public void init() {
        ...
        try {
            ...
            log("ModificarBeneficio Initialization Failure", e);
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        this.getTaDescripcion().setText(beneficio.getDescripcion());
        if (beneficio.getMonto() != null) {
            this.getTfMonto().setText(beneficio.getMonto().toString());
        }
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getComunicationAccionSocialBean().getRemoteSystemFichaSocial().updateBeneficio(beneficio);

                info("El Beneficio se modific\363 exitosamente.");
