 ...
 */
public class AgregarBeneficio extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        Option[] op = null;
        // Tipo de Obligacion
        op = this.getApplicationBean1().getMgrDropDown().armarArrayOptionsList(TipoBeneficio.values(), "cap");
        ddTipoBeneficioDefaultOptions.setOptions(op);

    }
    private DropDown ddTipoBeneficio = new DropDown();
    ...
    private SingleSelectOptionsList ddTipoBeneficioDefaultOptions = new SingleSelectOptionsList();
    ...
    private final String NOMBRE_PAGINA = "Agregar Beneficio";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AgregarBeneficio";
    ...
    private TextField tfTipoBeneficio = new TextField();

    public TextField getTfTipoBeneficio() {
        return tfTipoBeneficio;
    }

    public void setTfTipoBeneficio(TextField tfCodigo) {
        this.tfTipoBeneficio = tfCodigo;
    }
    private Button btnSeleccionarTipoBeneficio = new Button();

    public Button getBtnSeleccionarTipoBeneficio() {
        return btnSeleccionarTipoBeneficio;
    }

    public void setBtnSeleccionarTipoBeneficio(Button b) {
        this.btnSeleccionarTipoBeneficio = b;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("AgregarBeneficio Initialization Failure", e);
    ...
    private void guardarEstadoObjetosUsados() {
        ...
        Object tipoBeneficio = this.getDdTipoBeneficio().getValue();
        ...
        if (monto != null && !monto.toString().equals("") && v.esFlotante(monto.toString())) {
            beneficio.setMonto(Double.valueOf(Double.parseDouble(monto.toString())));
        }

        if (descripcion != null && descripcion != "") {
            beneficio.setDescripcion(descripcion.toString());
        } else {
        ...
        if (tipoBeneficio != null && !tipoBeneficio.toString().equals("")) {
            beneficio.setTipoBeneficio((TipoBeneficio.valueOf(tipoBeneficio.toString())));
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        if (this.getRequestBean1().getObjetoABM() != null) {
            beneficio = (Beneficio) this.getRequestBean1().getObjetoABM();
            this.getElementoPila().getObjetos().set(0, beneficio);
...
//        this.getTfCodigo().setText(beneficio.getCodigo());
    ...
    public String btnGuardar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                int pos = 0;
                int posf = 0;
                flotantes[posf] = this.getTfMonto();
                nomflotantes[posf++] = "Monto";


                
                noVacios[pos] = this.getTfNombre();
                nomNoVacios[pos++] = "Nombre";
                noVacios[pos] = this.getDdTipoBeneficio();
                nomNoVacios[pos++] = "Tipo de Beneficio";
        ...
        //        this.getCommunicationAccionSocialBean().getRemoSystemFichaSocial().setLlave(this.getSessionBean1().getLlave());
                this.getCommunicationAccionSocialBean().getRemoteSystemFichaSocial().addbeneficio(beneficio);

                info("El Beneficio se agreg\363 exitosamente.");
    ...
    public String btnSeleccionarTipoBeneficio_action() {
        String retorno = null;
        boolean ultimo = this.ultimoElementoPilaDeSubSesion();
