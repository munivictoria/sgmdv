 ...
 */
public class EliminarBeneficio extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "Eliminar Beneficio";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "EliminarBeneficio";
  ...
  private Label label1 = new Label();
    ...
    public void init() {
        ...
        try {
            ...
            log("EliminarBeneficio Initialization Failure", e);
...
//        ep.getObjetos().add(ind++, new TipoBeneficio());
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        if (this.getRequestBean1().getObjetoSeleccion() != null) {
            Object seleccionado = this.getRequestBean1().getObjetoSeleccion();
            // CAMBIAR: Crear los if necesarios para cada posible objeto a seleccionar.ge
    ...
    public String btnEliminar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                this.getComunicationAccionSocialBean().getRemoteSystemFichaSocial().deleteBeneficio(beneficio);

                info("La Beneficio se elimin\363 exitosamente.");
