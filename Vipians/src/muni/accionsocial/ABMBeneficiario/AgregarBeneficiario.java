 ...
 */
public class AgregarBeneficiario extends AbstractPageBean {
    ...
    private final String NOMBRE_PAGINA = "AgregarBeneficiario";
    // nombre del caso de navegacion para llegar a esta pagina.
    private final String CASO_NAVEGACION = "AgregarBeneficiario";
    ...
    public void init() {
        ...
        try {
            ...
            log("AgregarBeneficiario Initialization Failure", e);
...
//                nomNoVacios[pos++] = "Ingresos";
                ...
                info("El Beneficiario se agreg\363 exitosamente.");
