 ...
 */
public class EliminarBeneficiario extends AbstractPageBean {
...
//        }
        ...
        if ((vinculoSelected != null) && (vinculoSelected.toString().length() > 0)) {
...
//                this.getCommunicationAccionSocialBean().getre.setLlave(this.getSessionBean1().getLlave());
//                this.getCommunicationAccionSocialBean().getRemoteSystemFichaSocial().dedeleteBien(beneficiario);
                
                info("El Bien se elimin\363 exitosamente.");
            } catch (Exception ex) {
    ...
    public String btnCancelar_action() {
        ...
        if (ultimo) {
            this.getRequestBean1().setRespuestaABM(beneficiario);
