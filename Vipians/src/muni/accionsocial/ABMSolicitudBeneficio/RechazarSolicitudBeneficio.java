 ...
 */
public class RechazarSolicitudBeneficio extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        Option[] op = null;
        op = this.getApplicationBean1().getMgrDropDown().armarArrayOptions(SolicitudBeneficio.Estado.values(), "may");
    ...
    private Button btnRechazar = new Button();
    ...
    private TextArea taComentarioFin = new TextArea();

    public TextArea getTaComentarioFin() {
        return taComentarioFin;
    }

    public void setTaComentarioFin(TextArea taComentarioFin) {
        this.taComentarioFin = taComentarioFin;
    }
     ...
     */
    public RechazarSolicitudBeneficio() {
    }
...
//
        Object fechaFin = this.getTfFechaFin().getText();
//        Object cantidad = this.getTfCantidad().getText();
//        Object fechaFinalizacion = this.getTfFechaFin().getText();
//        Object monto = this.getTfMonto().getText();
        Object comentarioFin = this.getTaComentarioFin().getText();
...
//        }
        if (fechaFin != null && fechaFin != "") {
            solicitudBeneficio.setFechaFinalizacion(Conversor.getFechaCortaDeString(fechaFin.toString()));
        } else {
            solicitudBeneficio.setFechaFinalizacion(null);
        }
...
//            solicitudBeneficio.setFechaFinalizacion(Conversor.getFechaCortaDeString(fechaFinalizacion.toString()));
//        } else {
//            solicitudBeneficio.setFechaFinalizacion(null);
//        }
//        if (monto != null && monto != "") {
...
//        }
        if (comentarioFin != null && comentarioFin != "") {
            solicitudBeneficio.setComentarioFinalizacion(comentarioFin.toString());
        } else {
            solicitudBeneficio.setComentarioFinalizacion(null);
        }
...
//            estadoSolicitudBeneficio = SolicitudBeneficio.Estado.valueOf(estadoSelected.toString());
//        } else {
//            estadoSolicitudBeneficio = null;
//        }
//        solicitudBeneficio.setEstado(estadoSolicitudBeneficio);
//
        ind = 0;
...
//        this.getElementoPila().getObjetos().set(ind++, beneficio);
    ...
    private void mostrarEstadoObjetosUsados() {
        ...
        if (this.getRequestBean1().getObjetoABM() != null) {
            ...
            beneficio = (Beneficio) solicitudBeneficio.getBeneficio();
        ...
        this.getTfCantidad().setText(solicitudBeneficio.getCantidad().toString());
        this.getTfMonto().setText(Conversor.getStringDeDouble(solicitudBeneficio.getMonto()));
        this.getTfFechaFin().setText(Conversor.getStringDeFechaCorta(fecha));
        this.getTaComentarioFin().setText(solicitudBeneficio.getComentarioFinalizacion());
        this.getTaDescripcion().setText(solicitudBeneficio.getDescripcion());
        this.getDdEstado().setSelected(Util.getEnumNameFromString(String.valueOf(solicitudBeneficio.getEstado())));
        this.getDdEstadoDefaultOptions().setSelectedValue(Util.getEnumNameFromString(String.valueOf(solicitudBeneficio.getEstado())));
    }
    // </editor-fold>
    ...
    public String btnRechazar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                int pos = 0;
                noVacios[pos] = this.getTfFechaFin();
                nomNoVacios[pos++] = "Fecha de Finalizaci\363n";
                noVacios[pos] = this.getTaComentarioFin();
                nomNoVacios[pos++] = "Comentario de Finalizaci\363n";

                pos = 0;
                fecha[pos] = this.getTfFechaFin();
                nomFecha[pos++] = "Fecha de Finalizaci\363n";
                ...
                solicitudBeneficio.setEstado(SolicitudBeneficio.Estado.RECHAZADA);
...
//                this.getComunicationAccionSocialBean().getRemoteSystemFichaSocial().addSolicitudBeneficio();
                ...
                info("La Solicitud de Beneficio se cancel\363 exitosamente.");
