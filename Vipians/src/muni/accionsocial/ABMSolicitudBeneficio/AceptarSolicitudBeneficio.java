 ...
 */
public class AceptarSolicitudBeneficio extends AbstractPageBean {
     ...
     */
    public AceptarSolicitudBeneficio() {
    }
    ...
    public String btnAceptar_action() {
        ...
        if (ultimo) {
            ...
            try {
                ...
                solicitudBeneficio.setEstado(SolicitudBeneficio.Estado.ENTREGADA);
...
//                this.getComunicationAccionSocialBean().getRemoteSystemFichaSocial().addSolicitudBeneficio();
                ...
                info("La Entrega de la Solicitud de Beneficio se acept\363 exitosamente.");
