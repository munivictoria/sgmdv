										...
										<table align="center" width="70%">
											...
											<tr>
												<td align="right" nowrap="nowrap">
													<ui:label binding="#{expedientes$ABMExpediente$ABMTramite.lblEstado}" for="ddEstado" id="label10" styleClass="label"
														text="Estado" />
												</td>
											...
											<tr>
												<td colspan="4" align="left" nowrap="true">
													<ui:textArea binding="#{expedientes$ABMExpediente$ABMTramite.taComentarios}" columns="112" id="taComentarios"
														styleClass="textArea" />
												</td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="4" align="left" nowrap="true">
													<ui:listbox binding="#{expedientes$ABMExpediente$ABMTramite.lbHitos}" id="lbHitos"
														items="#{expedientes$ABMExpediente$ABMTramite.lbHitosDefaultOptions.options}" rows="5" style="width:100%"
														styleClass="textField" />
												</td>
											</tr>
											<tr>
												...
												<td colspan="4">
													<ui:panelGroup binding="#{expedientes$ABMExpediente$ABMTramite.panelPlazoExpediente.pgPlazo}">
														<h:panelGrid columns="10" width="100%">
															...
															<ui:textField disabled="true" binding="#{expedientes$ABMExpediente$ABMTramite.panelPlazoExpediente.tfCantidadDias}"
												...
												<td colspan="4">
													<ui:table augmentTitle="false" binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.table}" id="tableDocumentos">
														<ui:tableRowGroup binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.tableRowGroup1}" id="tableRowGroup1"
															...
															<ui:tableColumn align="center" binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.tableColumn1}"
																id="tableColumn1" valign="middle" width="10" rendered="false">
											...
											<tr>
												<td colspan="4">
													<ui:label binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.tituloProcesarDocumentos}"
														id="tituloProcesarDocumentos" styleClass="label2" text="Documentos para procesar" />
												</td>
											</tr>
											<tr>
												<td colspan="4">
													<ui:table augmentTitle="false" binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.tableProcesarDocumentos}"
														id="tableProcesarDocumentos">
														<ui:tableRowGroup binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.tableRowGroup2}" id="tableRowGroup2"
															sourceData="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.objectListDataProvider2}" sourceVar="currentRow2">
															<ui:tableColumn align="center" binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.tableColumn3}"
																id="tableColumn3" valign="middle" width="10">
																<ui:radioButton binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.radioButton2}" id="radioButton2" label=""
																	name="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.nombreButtonGroup2}"
																	selectedValue="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.currentRow2}" />
															</ui:tableColumn>
															<ui:tableColumn binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.tableColumn4}" headerText="Nombre"
																id="tableColumn4" sort="plantilla" width="40">
																<ui:staticText binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.staticText2}" id="staticText2"
																	text="#{currentRow2.value['plantilla']}" />
															</ui:tableColumn>
															<ui:tableColumn headerText="Procesado" sort="procesado" id="tableColumn5" width="10">
																<ui:checkbox binding="#{expedientes$ABMExpediente$ABMTramite.cbProcesado}" selected="#{currentRow2.value['procesado']}"
																	id="cbProcesado" disabled="true" />
															</ui:tableColumn>
														</ui:tableRowGroup>
														<f:facet name="actionsTop">
															<ui:panelGroup binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.groupPanel2}" id="groupPanel2">
																<ui:button action="#{expedientes$ABMExpediente$ABMTramite.btnProcesarReporte_action}"
																	binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.btnProcesarReporte}" id="btnProcesarReporte"
																	styleClass="button" text="Procesar" />
																<ui:button action="#{expedientes$ABMExpediente$ABMTramite.btnImprimirReporte_action}"
																	binding="#{expedientes$ABMExpediente$ABMTramite.tableDocumentos.btnImprimirReporte}" id="btnImprimirReporte"
																	styleClass="button" text="Imprimir" onClick="newWindow = window.open('/Vipians/faces/DescargarArchivoServlet', 'Reporte')" />
															</ui:panelGroup>
														</f:facet>
													</ui:table>
												</td>
