										...
										<ui:table augmentTitle="false" binding="#{expedientes$ABMResponsable$ABMResponsable.tableArea}" id="tableArea">
											<script>
												...
												function disableActions() {
													...
													document.getElementById("form1:tableArea:tableActionsTop:deleteTop").setDisabled(disabled);
													// Set disabled state for bottom actions
													document.getElementById("form1:tableArea:tableActionsBottom:deleteBottom").setDisabled(disabled);
												}
												]]>
											</script>
