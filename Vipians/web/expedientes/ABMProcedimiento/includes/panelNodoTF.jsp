...
<h:panelGrid styleClass="tablaInterna"
	...
	<ui:panelGroup styleClass="div" block="true"
		visible="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.renderedNodo}">
		<ui:label text="NODO"
			binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.lTitulo}" />
	</ui:panelGroup>
	<ui:panelGroup block="true"
		visible="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.renderedNodo}">
		<h:panelGrid columns="2">
			<ui:label for="NTFtfNombre" id="NTFlblNombre" styleClass="label"
				text="Nombre" />
			<ui:textField columns="40" id="NTFtfNombre" styleClass="textField"
				disabled="true"
				binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.tNombre}" />
		</h:panelGrid>
	</ui:panelGroup>

	<ui:panelGroup styleClass="div"
		visible="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.renderedNodo}"
	...
	<ui:panelGroup block="true"
		...
		<h:panelGrid columns="5">
			<ui:label for="NTFtfCantDias" id="NTFlblCantDias" styleClass="label"
	...
	<ui:panelGroup block="true"
		...
		<h:panelGrid columns="2" columnClasses="col,col">
			<ui:panelGroup binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.gpAreas1}" id="P_NTFgroupPanelAreas1" style="white-space: nowrap">
				<ui:button onClick="clickButton(this.id);" reset="true"
					id="P_NTFbtnAgregar" styleClass="button" text="Agregar" />
				<ui:button onClick="clickButton(this.id);" reset="true"
					id="P_NTFbtnQuitar" text="Quitar" styleClass="button" />
				<ui:staticText escape="false" id="P_NTFstaticText4" text="|" />
				<ui:button onClick="clickButton(this.id);" reset="true"
					styleClass="button" id="P_NTFbtnQuitarTodos" text="Quitar Todos" />
			</ui:panelGroup>
			<ui:panelGroup binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.gpUsuarios1}" id="P_NTFgroupPanelUsuarios1" style="white-space: nowrap">
				<ui:button onClick="clickButton(this.id);" reset="true"
					id="P_NTFbtnAgregarUsuario" styleClass="button" text="Agregar" />
				<ui:button onClick="clickButton(this.id);" reset="true"
					styleClass="button" id="P_NTFbtnQuitarUsuario" text="Quitar" />
				<ui:staticText escape="false" id="P_NTFstaticTextUsuario4" text="|" />
				<ui:button onClick="clickButton(this.id);" reset="true"
					id="P_NTFbtnQuitarTodosUsuarios" text="Quitar todos"
					styleClass="button" />
			</ui:panelGroup>

			<ui:table augmentTitle="false" id="NTFtableAreas"
				binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.panelResponsable.tableAreas.table}"
				style="width: 100px;">
				<ui:tableRowGroup id="NTFtableRowGroup1"
					...
					<ui:tableColumn binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.tcAreas1}" align="center" id="NTFtableColumn1" valign="middle"
						width="7">
					...
					<ui:tableColumn headerText="Area" id="NTFtableColumn2">
						<ui:staticText id="NTFstaticText2"
							text="#{currentRow.value['area'].nombre}" />
					</ui:tableColumn>
					<ui:tableColumn headerText="Responsabilidad" id="NTFtcResponsabilidadArea">
						<ui:dropDown id="ddResponsabilidadArea" styleClass="textField" binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.ddResponsabilidadArea}"
			...
			<ui:table augmentTitle="false"
				binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.panelResponsable.tableUsuarios.table}"
				id="tableUsuarios" style="width: 100px;">
				<ui:tableRowGroup
					binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.panelResponsable.tableUsuarios.tableRowGroup1}"
					...
					sourceVar="currentRow">
					<ui:tableColumn align="center" binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.panelResponsable.tableUsuarios.tableColumn1}"
					...
					<ui:tableColumn
						binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.panelResponsable.tableUsuarios.tableColumn2}"
					...
					<ui:tableColumn headerText="Responsabilidad" id="NTFtcResponsabilidadUsuario">
						<ui:dropDown id="ddResponsabilidadUsuario" styleClass="textField" binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.ddResponsabilidadUsuario}"
							items="#{expedientes$ABMProcedimiento$ABMProcedimiento.optionsResponsabilidad}"
							selected="#{currentRow.value['responsabilidad']}" converter="EnumConverter" immediate="false" />
					</ui:tableColumn>
				</ui:tableRowGroup>
		...
		<ui:panelGroup binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.gpUsuariosExtensores}" 
			visible="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.renderedNodo}"
			id="P_NTFgroupPanelUsuariosExtensores" style="white-space: nowrap">
				<ui:button onClick="clickButton(this.id);" reset="true"
					id="P_NTFbtnAgregarUsuariosExtensores" styleClass="button" text="Agregar" />
				<ui:button onClick="clickButton(this.id);" reset="true"
					styleClass="button" id="P_NTFbtnQuitarUsuarioExtensores" text="Quitar" />
				<ui:staticText escape="false" id="P_NTFstaticTextUsuarioExtensores" text="|" />
				<ui:button onClick="clickButton(this.id);" reset="true"
					id="P_NTFbtnQuitarTodosUsuariosExtensores" text="Quitar todos"
					styleClass="button" />
			...
			<ui:table augmentTitle="false"
				...
				<ui:tableRowGroup
					...
					sourceVar="currentRow">
					<ui:tableColumn align="center" binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelEditNodo.panelResponsable.tableUsuariosExtensores.tableColumn1}"
