								...
								<tr>
									<td>
										<table align="center" width="70%">
													...
													<table class="verde" style="border: 0px; padding: 5px 1px; width: 100%; border-radius: 10px; box-shadow: 0px -2px 10px #BBB;">
														<tr>
															<td align="right" nowrap="true">
																<ui:label binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.lblNombre}" for="tfNombre" id="lblNombre"
														...
														<tr>
															<td align="right" nowrap="true">
																<ui:label binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.lblNumerador}" for="ddNumerador" id="lblNumerador"
																	styleClass="label" text="Numerador" />
															</td>
															<td>
																<ui:dropDown binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.ddNumerador}" id="ddNumerador"
																	items="#{expedientes$ABMProcedimiento$ABMProcedimiento.ddNumeradorDefaultOptions.options}" styleClass="textField" />
															</td>
														</tr>
													</table>
												</td>
																...
																<td>
																	<ui:panelGroup binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelResponsable.tableUsuarios.groupPanel1}"
																		...
																		<ui:button action="#{expedientes$ABMProcedimiento$ABMProcedimiento.btnAgregarUsuario_action}"
																			binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelResponsable.tableUsuarios.btnAgregar}"
																			id="btnAgregarUsuario" styleClass="button" text="Agregar" />
												...
												<td colspan="2" style="padding-left: 1px; padding-right: 1px;" valign="top">
													<h:panelGrid styleClass="tablaInterna" width="100%" style="-moz-border-radius: 0px 0px 5px 5px;">
														...
														<h:panelGrid columns="3">
															...
															<ui:textField binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.panelPlazo.tfCantidadDias}" columns="4"
											...
											<tr>
												<td>
													<TABLE style="background-color: rgb(221, 221, 221);" align="center" width="100%">
														<tbody>
															<tr>
																<td colspan="2">
																...
																<td colspan="3" style="background-color: rgb(242, 242, 236);">
																	<ui:panelGroup binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.trProcedimiento.gpBotones}" id="gpBotones">
																		...
																		<ui:button action="#{expedientes$ABMProcedimiento$ABMProcedimiento.btnAgregarFaseEspecial_action}"
																			binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.trProcedimiento.btnAgregarFaseEspecial}"
																			id="btnAgregarFaseEspecial" styleClass="button" text="Agregar Fase Especial" />
																		...
																		<a4j:commandButton reRender="form1:incTreeProcedimiento:trProcedimiento, form1:btnQuitarElemento"
																			...
																			styleClass="btnAjax" value="Quitar Elemento" oncomplete="seleccionarNodoRaiz()"
											...
											<tr>
												<td colspan="4">
													<a4j:outputPanel ajaxRendered="true">
														<ui:messageGroup binding="#{expedientes$ABMProcedimiento$ABMProcedimiento.messageGroup}" id="messageGroup"
															styleClass="grupoMsg" />
													</a4j:outputPanel>
												</td>
											</tr>
