										...
										<ui:table augmentTitle="false" binding="#{expedientes$ABMFaseProcedimiento$ABMFaseProcedimiento.table.table}" id="tableTP">
											<script>
												...
												function disableActions() {
													...
													document.getElementById("form1:tableTP:tableActionsTop:deleteTop").setDisabled(disabled);
													// Set disabled state for bottom actions
													document.getElementById("form1:tableTP:tableActionsBottom:deleteBottom").setDisabled(disabled);
												}
												]]>
											</script>
