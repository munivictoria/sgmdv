									...
									<td>
										<table align="center" width="70%">
											...
											<tr>
												...
												<td>
													<ui:textField binding="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.tfNombre}" columns="40" id="tfNombre"
													...
													<ui:table augmentTitle="false" binding="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.tableTC.table}" id="tableTC">
														<script>
															...
															function disableActions() {
																...
																document.getElementById("form1:tableTC:tableActionsTop:deleteTop").setDisabled(
																		disabled);
																// Set disabled state for bottom actions
																document.getElementById("form1:tableTC:tableActionsBottom:deleteBottom").setDisabled(
																		disabled);
															}
															]]>
														</script>
														<ui:tableRowGroup binding="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.tableTC.tableRowGroup1}" id="tableRowGroup1"
															...
															<ui:tableColumn align="center" binding="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.tableTC.tableColumn1}"
														...
														<f:facet name="actionsTop">
															<ui:panelGroup binding="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.tableTC.groupPanel1}" id="groupPanel1">
																<ui:button action="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.btnAgregarTC_action}"
																	binding="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.tableTC.btnAgregar}" id="btnAgregar" styleClass="button"
																	text="Agregar" />
																<a4j:commandButton action="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.btnQuitarTC_action}"
																	binding="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.tableTC.btnQuitar}" id="btnQuitar" value="Quitar"
																	styleClass="btnAjax" reRender="tableTC"
																	onmousedown="reemplazarClickConConfirmacionEnTabla('form1:tableTC', true, this, '');" />
																...
																<a4j:commandButton action="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.btnQuitarTodosTC_action}"
																	...
																	styleClass="btnAjax" reRender="tableTC"
																	onmousedown="reemplazarClickConConfirmacionEnTabla('form1:tableTC', false, this, '¿Está seguro que desea quitar todos los elementos de esta lista?');" />
															</ui:panelGroup>
														</f:facet>
													</ui:table>
												</td>
											...
											<tr>
												<td colspan="4">
													<ui:table augmentTitle="false" binding="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.tablaFaseEspecial}"
														id="tablaFaseEspecial">
														<script>
															<![CDATA[
															/* ----- Functions for Table Preferences Panel ----- */
															/*
															...
															function disableActions() {
																...
																// Set disabled state for bottom actions
																document.getElementById("form1:tablaFaseEspecial:tableActionsBottom:deleteBottom")
																		.setDisabled(disabled);
															}
															]]>
														</script>
														...
														<f:facet name="actionsTop">
															<ui:panelGroup binding="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.groupPanel1}" id="groupPanel1">
																...
																<a4j:commandButton action="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.btnQuitarFaseEspecial_action}"
																	...
																	onmousedown="reemplazarClickConConfirmacionEnTabla('form1:tablaFaseEspecial', true, this, '');" />
																...
																<a4j:commandButton action="#{expedientes$ABMFaseCatalogo$ABMFaseCatalogo.btnQuitarTodas_action}"
																	...
																	styleClass="btnAjax" reRender="tablaFaseEspecial"
																	onmousedown="reemplazarClickConConfirmacionEnTabla('form1:tablaFaseEspecial', false, this, '¿Está seguro que desea quitar todos los elementos de esta lista?');" />
															</ui:panelGroup>
														</f:facet>
													</ui:table>
												</td>
