    ...
    <f:view>
        <ui:page binding="#{comunes$ABMDomicilio$ConsultarDomicilio.page1}" id="page1">
            <ui:html binding="#{comunes$ABMDomicilio$ConsultarDomicilio.html1}" id="html1">
                ...
                <ui:body binding="#{comunes$ABMDomicilio$ConsultarDomicilio.body1}" focus="form1:tfNumero" id="body1" onLoad="parent.footer.location.reload();Init();" style="background-color: rgb(242, 242, 242); -rave-layout: grid" onKeyUp="eventoByEscape(event,'btnVolver')">
                    <ui:form binding="#{comunes$ABMDomicilio$ConsultarDomicilio.form1}" id="form1">
                        ...
                        <ui:script binding="#{comunes$ABMDomicilio$ConsultarDomicilio.scriptValidador}" id="scriptValidador" url="/resources/javascript/validador.js"/>
                    </ui:form>
                </ui:body>
            </ui:html>
        </ui:page>
