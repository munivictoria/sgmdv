...
/**
 * Permite obtener en letras cualquier número positivo hasta 999.999.999,99 centavos. Debe pasarse como parámetro el número sin separador de miles y con la coma
 * decimal si se requiere. ejemplos: 15000,56; 15000
 */
		...
		if(this.puntoDecimal != null && this.puntoDecimal > 0) {
			...
			switch(locParteDecimal.length()) {
				case 0:
					locStringRetorno = "";
				case 1:
					locStringRetorno = this.getUnidad(locParteDecimal);
					break;
				case 2:
					locStringRetorno = this.getDecena(locParteDecimal);
					break;
				case 3:
					locStringRetorno = this.getDecena(locParteDecimal);
					break;
