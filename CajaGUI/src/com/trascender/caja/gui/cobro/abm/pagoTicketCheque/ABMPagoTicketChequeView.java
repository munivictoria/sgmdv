...
public abstract class ABMPagoTicketChequeView extends ABMView{
	
	private PagoTicketChequeABMModel abmModel;
	...
	public ABMPagoTicketChequeView(JDialog owner) {
		super(owner);
		this.init();
	}
	
	public ABMPagoTicketChequeView(JFrame owner) {
		super(owner);
		this.init();
	}
	...
	public void setAbmModel(PagoTicketChequeABMModel abmModel) {
