...
public abstract class ABMPagoTicketCompensacionView extends ABMView{
	
	private PagoTicketCompensacionABMModel abmModel;
	...
	public ABMPagoTicketCompensacionView(JDialog owner) {
		super(owner);
		this.init();
	}
	
	public ABMPagoTicketCompensacionView(JFrame owner) {
		super(owner);
		this.init();
	}
	...
	public void setAbmModel(PagoTicketCompensacionABMModel abmModel) {
