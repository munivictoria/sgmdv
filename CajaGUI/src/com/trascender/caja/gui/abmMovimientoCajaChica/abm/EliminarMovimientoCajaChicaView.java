...
public class EliminarMovimientoCajaChicaView extends ABMMovimientoCajaChicaView {

	private static final long serialVersionUID = 1L;

	public EliminarMovimientoCajaChicaView (JDialog owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesCaja.getString("EliminarMovimientoCajaChica.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesCaja.getString("EliminarMovimientoCajaChica.titulo");
