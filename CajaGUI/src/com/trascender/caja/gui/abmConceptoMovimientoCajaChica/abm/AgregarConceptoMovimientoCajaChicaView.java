...
public class AgregarConceptoMovimientoCajaChicaView extends ABMConceptoMovimientoCajaChicaView {

	private static final long serialVersionUID = 3693899650276335195L;

	public AgregarConceptoMovimientoCajaChicaView(JDialog owner) {
		super(owner);
		this.init();
	}
	
	public AgregarConceptoMovimientoCajaChicaView(JFrame owner) {
		super(owner);
		this.init();
	}
	...
	public void setDescripcionVentana() {
		this.getPnlCabecera().getLblDescripcion().setText(MessagesCaja.getString("AgregarConceptoMovimientoCajaChica.descripcion"));
	}
	...
	public void setTituloVentana() {
		String locTitulo = MessagesCaja.getString("AgregarConceptoMovimientoCajaChica.titulo");
