...
public class AdminPersonaFisicaView extends AdminView {
	...
	private void init() {
		...
		this.lblCuil.setText(MessagesCaja.getString(this.NOMBRE_RECURSO+".lblCuil"));
		...
		this.lblDocumento.setText(MessagesCaja.getString(this.NOMBRE_RECURSO+".lblDocumento"));
		...
		this.lblApellido.setText(MessagesCaja.getString(this.NOMBRE_RECURSO+".lblApellido"));
