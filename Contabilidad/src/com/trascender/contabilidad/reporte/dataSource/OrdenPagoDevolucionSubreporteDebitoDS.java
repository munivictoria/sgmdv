...
public class OrdenPagoDevolucionSubreporteDebitoDS extends TrascenderDataSource{
	private int lineaActual = -1;
	private Map <String, Object>parametros;
	private List <Debito> listaLineas;
	
	public OrdenPagoDevolucionSubreporteDebitoDS(List<Debito> plistaDebito) throws Exception{
