...
public class ChequeDiferidoDS extends TrascenderDataSource{
	private int lineaActual = -1;
	private Map <String, Object>parametros;
	private Cheque locCheque;
	
	public ChequeDiferidoDS(Cheque pCheque) throws Exception{
		...
		locCalendar.setTime(locCheque.getFechaPago());
		parametros.put("PAR_DIA_PAGO", locCalendar.get(Calendar.DAY_OF_YEAR));
		parametros.put("PAR_MES_PAGO", locCalendar.get(Calendar.MONTH));
		parametros.put("PAR_ANIO_PAGO", locCalendar.get(Calendar.YEAR));
	...
	public String getNombreReporte() {
		return "Reporte_Cheque_Pago_Diferido.jasper";
	}
